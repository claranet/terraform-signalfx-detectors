resource "signalfx_detector" "messages_ready" {
  name = format("%s %s", local.name_prefix, "RabbitMQ Queue messages ready")
...
resource "signalfx_detector" "messages_unacknowledged" {
  name = format("%s %s", local.name_prefix, "RabbitMQ Queue messages unacknowledged")
...
resource "signalfx_detector" "messages_ack_rate" {
  name = format("%s %s", local.name_prefix, "RabbitMQ Queue messages ack rate")
...
resource "signalfx_detector" "consumer_use" {
  name = format("%s %s", local.name_prefix, "RabbitMQ Queue consumer use")
