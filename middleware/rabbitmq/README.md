...
| file\_descriptors\_transformation\_function | Transformation function for file descriptors detector \(mean, min, max\) | string | `"mean"` | no |
...
| processes\_transformation\_function | Transformation function for processes detector \(mean, min, max\) | string | `"mean"` | no |
...
| sockets\_transformation\_function | Transformation function for sockets detector \(mean, min, max\) | string | `"mean"` | no |
...
| vm\_memory\_transformation\_function | Transformation function for vm\_memory detector \(mean, min, max\) | string | `"mean"` | no |
