resource "signalfx_detector" "nginx_ingress_5xx" {
  name = format("%s %s", local.name_prefix, "Kubernetes Ingress Nginx 5xx errors ratio")
...
resource "signalfx_detector" "nginx_ingress_4xx" {
  name = format("%s %s", local.name_prefix, "Kubernetes Ingress Nginx 4xx errors ratio")
...
resource "signalfx_detector" "nginx_ingress_latency" {
  name = format("%s %s", local.name_prefix, "Kubernetes Ingress Nginx latency")
