resource "signalfx_detector" "heartbeat" {
  name = format("%s %s", local.name_prefix, "Kubernetes node heartbeat")

  program_text = <<-EOF
    from signalfx.detectors.not_reporting import not_reporting
    signal = data('kubernetes.node_ready', filter=${local.heartbeat_filters} and ${module.filter-tags.filter_custom})${var.heartbeat_aggregation_function}.publish('signal')
...
resource "signalfx_detector" "node_ready" {
  name = format("%s %s", local.name_prefix, "Kubernetes node status")
...
resource "signalfx_detector" "pod_phase_status" {
  name = format("%s %s", local.name_prefix, "Kubernetes pod status phase")
...
resource "signalfx_detector" "terminated" {
  name = format("%s %s", local.name_prefix, "Kubernetes pod terminated abnormally")
...
resource "signalfx_detector" "oom_killed" {
  name = format("%s %s", local.name_prefix, "Kubernetes container killed by OOM")
...
resource "signalfx_detector" "deployment_crashloopbackoff" {
  name = format("%s %s", local.name_prefix, "Kubernetes deployment in CrashLoopBackOff")
...
resource "signalfx_detector" "daemonset_crashloopbackoff" {
  name = format("%s %s", local.name_prefix, "Kubernetes daemonset in CrashLoopBackOff")
...
resource "signalfx_detector" "job_failed" {
  name = format("%s %s", local.name_prefix, "Kubernetes job from cronjob failed")
...
resource "signalfx_detector" "daemonset_scheduled" {
  name = format("%s %s", local.name_prefix, "Kubernetes daemonsets not scheduled")
...
resource "signalfx_detector" "daemonset_ready" {
  name = format("%s %s", local.name_prefix, "Kubernetes daemonsets not ready")
...
resource "signalfx_detector" "daemonset_misscheduled" {
  name = format("%s %s", local.name_prefix, "Kubernetes daemonsets misscheduled")
...
resource "signalfx_detector" "deployment_available" {
  name = format("%s %s", local.name_prefix, "Kubernetes deployments available")
...
resource "signalfx_detector" "replicaset_available" {
  name = format("%s %s", local.name_prefix, "Kubernetes replicasets available")
...
resource "signalfx_detector" "replication_controller_available" {
  name = format("%s %s", local.name_prefix, "Kubernetes replication_controllers available")
...
resource "signalfx_detector" "satefulset_ready" {
  name = format("%s %s", local.name_prefix, "Kubernetes satefulsets ready")
