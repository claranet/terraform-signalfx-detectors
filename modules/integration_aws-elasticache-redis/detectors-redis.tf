...
EOF
  ...
  rule {
    ...
    runbook_url           = coalesce(var.cache_hits_runbook_url, var.runbook_url)
...
EOF
  ...
  rule {
    ...
    runbook_url           = coalesce(var.cpu_high_runbook_url, var.runbook_url)
...
EOF
  ...
  rule {
    ...
    runbook_url           = coalesce(var.commands_runbook_url, var.runbook_url)
