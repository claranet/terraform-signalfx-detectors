...
```hcl
module "signalfx-detectors-cloud-aws-rds-aurora-mysql" {
  source = "github.com/claranet/terraform-signalfx-detectors.git//cloud/aws/rds/aurora/mysql?ref={revision}"
...
* AWS RDS Aurora Mysql replica lag
