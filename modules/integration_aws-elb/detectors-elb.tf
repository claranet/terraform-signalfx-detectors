...
EOF
  ...
  rule {
    ...
    runbook_url           = var.no_healthy_instances_runbook_url
...
EOF
  ...
  rule {
    ...
    runbook_url           = var.elb_4xx_runbook_url
    tip                   = var.elb_4xx_tip
    parameterized_subject = local.rule_subject
    parameterized_body    = local.rule_body
  }
...
EOF
  ...
  rule {
    ...
    runbook_url           = var.elb_5xx_runbook_url
    tip                   = var.elb_5xx_tip
    parameterized_subject = local.rule_subject
    parameterized_body    = local.rule_body
  }
...
EOF
  ...
  rule {
    ...
    runbook_url           = var.backend_4xx_runbook_url
...
EOF
  ...
  rule {
    ...
    runbook_url           = var.backend_5xx_runbook_url
...
EOF
  ...
  rule {
    ...
    runbook_url           = var.backend_latency_runbook_url
