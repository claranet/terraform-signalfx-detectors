...
EOF
  ...
  rule {
    ...
    runbook_url           = var.node_ready_runbook_url
...
EOF
  ...
  rule {
    ...
    runbook_url           = var.pod_phase_status_runbook_url
...
EOF
  ...
  rule {
    ...
    runbook_url           = var.terminated_runbook_url
...
EOF
  ...
  rule {
    ...
    runbook_url           = var.oom_killed_runbook_url
...
EOF
  ...
  rule {
    ...
    runbook_url           = var.deployment_crashloopbackoff_runbook_url
...
EOF
  ...
  rule {
    ...
    runbook_url           = var.daemonset_crashloopbackoff_runbook_url
...
EOF
  ...
  rule {
    ...
    runbook_url           = var.job_failed_runbook_url
...
EOF
  ...
  rule {
    ...
    runbook_url           = var.daemonset_scheduled_runbook_url
...
EOF
  ...
  rule {
    ...
    runbook_url           = var.daemonset_ready_runbook_url
...
EOF
  ...
  rule {
    ...
    runbook_url           = var.daemonset_misscheduled_runbook_url
...
EOF
  ...
  rule {
    ...
    runbook_url           = var.deployment_available_runbook_url
...
EOF
  ...
  rule {
    ...
    runbook_url           = var.replicaset_available_runbook_url
...
EOF
  ...
  rule {
    ...
    runbook_url           = var.replication_controller_available_runbook_url
...
EOF
  ...
  rule {
    ...
    runbook_url           = var.satefulset_ready_runbook_url
