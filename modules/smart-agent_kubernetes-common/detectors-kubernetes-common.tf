...
resource "signalfx_detector" "job_failed" {
  ...
  program_text = <<-EOF
    ...
    B = data('kubernetes.job.active', extrapolation='zero', filter=${module.filtering.signalflow})${var.job_failed_aggregation_function}${var.job_failed_transformation_function}
    C = data('kubernetes.job.succeeded', extrapolation='zero', filter=${module.filtering.signalflow}, rollup='max')${var.job_failed_aggregation_function}${var.job_failed_transformation_function}
...
resource "signalfx_detector" "daemonset_scheduled" {
  ...
  program_text = <<-EOF
    ...
    B = data('kubernetes.daemon_set.current_scheduled', filter=${module.filtering.signalflow})${var.daemonset_scheduled_aggregation_function}${var.daemonset_scheduled_transformation_function}
...
resource "signalfx_detector" "daemonset_ready" {
  ...
  program_text = <<-EOF
    ...
    B = data('kubernetes.daemon_set.desired_scheduled', filter=${module.filtering.signalflow})${var.daemonset_ready_aggregation_function}${var.daemonset_ready_transformation_function}
...
resource "signalfx_detector" "deployment_available" {
  ...
  program_text = <<-EOF
    ...
    B = data('kubernetes.deployment.available', filter=${module.filtering.signalflow})${var.deployment_available_aggregation_function}${var.deployment_available_transformation_function}
...
resource "signalfx_detector" "replicaset_available" {
  ...
  program_text = <<-EOF
    ...
    B = data('kubernetes.replica_set.available', filter=${module.filtering.signalflow})${var.replicaset_available_aggregation_function}${var.replicaset_available_transformation_function}
    signal = (A-B).fill(0).publish('signal')
...
resource "signalfx_detector" "replication_controller_available" {
  ...
  program_text = <<-EOF
    ...
    B = data('kubernetes.replication_controller.available', filter=${module.filtering.signalflow})${var.replication_controller_available_aggregation_function}${var.replication_controller_available_transformation_function}
    signal = (A-B).fill(0).publish('signal')
...
resource "signalfx_detector" "statefulset_ready" {
  ...
  program_text = <<-EOF
    ...
    B = data('kubernetes.stateful_set.ready', filter=${module.filtering.signalflow})${var.statefulset_ready_aggregation_function}${var.statefulset_ready_transformation_function}
    signal = (A-B).fill(0).publish('signal')
