resource "signalfx_detector" "count" {
  ...
  program_text = <<-EOF
    ...
    detect(when(signal > ${var.count_threshold_critical}%{if var.count_lasting_duration_critical != null}, lasting='${var.count_lasting_duration_critical}', at_least=${var.count_at_least_percentage_critical}%{endif})).publish('CRIT')
    detect(when(signal > ${var.count_threshold_major}%{if var.count_lasting_duration_major != null}, lasting='${var.count_lasting_duration_major}', at_least=${var.count_at_least_percentage_major}%{endif}) and (not when(signal > ${var.count_threshold_critical}%{if var.count_lasting_duration_critical != null}, lasting='${var.count_lasting_duration_critical}', at_least=${var.count_at_least_percentage_critical}%{endif}))).publish('MAJOR')
EOF
...
resource "signalfx_detector" "ingress" {
  ...
  program_text = <<-EOF
    ...
    detect(when(signal > ${var.ingress_threshold_critical}%{if var.ingress_lasting_duration_critical != null}, lasting='${var.ingress_lasting_duration_critical}', at_least=${var.ingress_at_least_percentage_critical}%{endif})).publish('CRIT')
    detect(when(signal > ${var.ingress_threshold_major}%{if var.ingress_lasting_duration_major != null}, lasting='${var.ingress_lasting_duration_major}', at_least=${var.ingress_at_least_percentage_major}%{endif}) and (not when(signal > ${var.ingress_threshold_critical}%{if var.ingress_lasting_duration_critical != null}, lasting='${var.ingress_lasting_duration_critical}', at_least=${var.ingress_at_least_percentage_critical}%{endif}))).publish('MAJOR')
EOF
...
resource "signalfx_detector" "egress" {
  ...
  program_text = <<-EOF
    ...
    detect(when(signal > ${var.egress_threshold_critical}%{if var.egress_lasting_duration_critical != null}, lasting='${var.egress_lasting_duration_critical}', at_least=${var.egress_at_least_percentage_critical}%{endif})).publish('CRIT')
    detect(when(signal > ${var.egress_threshold_major}%{if var.egress_lasting_duration_major != null}, lasting='${var.egress_lasting_duration_major}', at_least=${var.egress_at_least_percentage_major}%{endif}) and (not when(signal > ${var.egress_threshold_critical}%{if var.egress_lasting_duration_critical != null}, lasting='${var.egress_lasting_duration_critical}', at_least=${var.egress_at_least_percentage_critical}%{endif}))).publish('MAJOR')
EOF
...
resource "signalfx_detector" "requests_rate" {
  ...
  program_text = <<-EOF
    ...
    detect(when(signal > ${var.requests_rate_threshold_critical}%{if var.requests_rate_lasting_duration_critical != null}, lasting='${var.requests_rate_lasting_duration_critical}', at_least=${var.requests_rate_at_least_percentage_critical}%{endif})).publish('CRIT')
    detect(when(signal > ${var.requests_rate_threshold_major}%{if var.requests_rate_lasting_duration_major != null}, lasting='${var.requests_rate_lasting_duration_major}', at_least=${var.requests_rate_at_least_percentage_major}%{endif}) and (not when(signal > ${var.requests_rate_threshold_critical}%{if var.requests_rate_lasting_duration_critical != null}, lasting='${var.requests_rate_lasting_duration_critical}', at_least=${var.requests_rate_at_least_percentage_critical}%{endif}))).publish('MAJOR')
EOF
