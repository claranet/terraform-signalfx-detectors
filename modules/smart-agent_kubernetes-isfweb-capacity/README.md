# KUBERNETES-ISFWEB-CAPACITY SignalFx detectors
...
```hcl
module "signalfx-detectors-smart-agent-kubernetes-isfweb-capacity" {
  source = "github.com/claranet/terraform-signalfx-detectors.git//modules/smart-agent_kubernetes-isfweb-capacity?ref={revision}"
