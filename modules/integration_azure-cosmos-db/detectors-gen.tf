...
resource "signalfx_detector" "database_4xx_request_rate" {
  ...
  program_text = <<-EOF
    ...
    detect(when(signal > ${var.database_4xx_request_rate_threshold_critical}%{if var.database_4xx_request_rate_lasting_duration_critical != null}, lasting='${var.database_4xx_request_rate_lasting_duration_critical}', at_least=${var.database_4xx_request_rate_at_least_percentage_critical}%{endif})).publish('CRIT')
    detect(when(signal > ${var.database_4xx_request_rate_threshold_major}%{if var.database_4xx_request_rate_lasting_duration_major != null}, lasting='${var.database_4xx_request_rate_lasting_duration_major}', at_least=${var.database_4xx_request_rate_at_least_percentage_major}%{endif}) and (not when(signal > ${var.database_4xx_request_rate_threshold_critical}%{if var.database_4xx_request_rate_lasting_duration_critical != null}, lasting='${var.database_4xx_request_rate_lasting_duration_critical}', at_least=${var.database_4xx_request_rate_at_least_percentage_critical}%{endif}))).publish('MAJOR')
EOF
...
resource "signalfx_detector" "database_5xx_request_rate" {
  ...
  program_text = <<-EOF
    ...
    detect(when(signal > ${var.database_5xx_request_rate_threshold_critical}%{if var.database_5xx_request_rate_lasting_duration_critical != null}, lasting='${var.database_5xx_request_rate_lasting_duration_critical}', at_least=${var.database_5xx_request_rate_at_least_percentage_critical}%{endif})).publish('CRIT')
    detect(when(signal > ${var.database_5xx_request_rate_threshold_major}%{if var.database_5xx_request_rate_lasting_duration_major != null}, lasting='${var.database_5xx_request_rate_lasting_duration_major}', at_least=${var.database_5xx_request_rate_at_least_percentage_major}%{endif}) and (not when(signal > ${var.database_5xx_request_rate_threshold_critical}%{if var.database_5xx_request_rate_lasting_duration_critical != null}, lasting='${var.database_5xx_request_rate_lasting_duration_critical}', at_least=${var.database_5xx_request_rate_at_least_percentage_critical}%{endif}))).publish('MAJOR')
EOF
...
resource "signalfx_detector" "scaling" {
  ...
  program_text = <<-EOF
    ...
    detect(when(signal > ${var.scaling_threshold_critical}%{if var.scaling_lasting_duration_critical != null}, lasting='${var.scaling_lasting_duration_critical}', at_least=${var.scaling_at_least_percentage_critical}%{endif})).publish('CRIT')
    detect(when(signal > ${var.scaling_threshold_major}%{if var.scaling_lasting_duration_major != null}, lasting='${var.scaling_lasting_duration_major}', at_least=${var.scaling_at_least_percentage_major}%{endif}) and (not when(signal > ${var.scaling_threshold_critical}%{if var.scaling_lasting_duration_critical != null}, lasting='${var.scaling_lasting_duration_critical}', at_least=${var.scaling_at_least_percentage_critical}%{endif}))).publish('MAJOR')
EOF
...
resource "signalfx_detector" "request_units_consumption" {
  ...
  program_text = <<-EOF
    ...
    detect(when(signal > ${var.request_units_consumption_threshold_critical}%{if var.request_units_consumption_lasting_duration_critical != null}, lasting='${var.request_units_consumption_lasting_duration_critical}', at_least=${var.request_units_consumption_at_least_percentage_critical}%{endif})).publish('CRIT')
    detect(when(signal > ${var.request_units_consumption_threshold_major}%{if var.request_units_consumption_lasting_duration_major != null}, lasting='${var.request_units_consumption_lasting_duration_major}', at_least=${var.request_units_consumption_at_least_percentage_major}%{endif}) and (not when(signal > ${var.request_units_consumption_threshold_critical}%{if var.request_units_consumption_lasting_duration_critical != null}, lasting='${var.request_units_consumption_lasting_duration_critical}', at_least=${var.request_units_consumption_at_least_percentage_critical}%{endif}))).publish('MAJOR')
EOF
