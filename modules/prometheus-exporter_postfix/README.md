...
```hcl
module "signalfx-detectors-prometheus-exporter-postfix" {
  source = "github.com/claranet/terraform-signalfx-detectors.git//modules/prometheus-exporter_postfix?ref={revision}"
