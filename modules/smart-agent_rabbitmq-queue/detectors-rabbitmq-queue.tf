...
EOF
  ...
  rule {
    ...
    runbook_url           = var.messages_ready_runbook_url
...
EOF
  ...
  rule {
    ...
    runbook_url           = var.messages_unacknowledged_runbook_url
...
EOF
  ...
  rule {
    ...
    runbook_url           = var.messages_ack_rate_runbook_url
...
EOF
  ...
  rule {
    ...
    runbook_url           = var.consumer_use_runbook_url
