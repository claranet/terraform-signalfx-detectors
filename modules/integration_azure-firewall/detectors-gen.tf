...
resource "signalfx_detector" "throughput" {
  ...
  program_text = <<-EOF
    ...
    detect(when(signal >= ${var.throughput_threshold_warning}%{if var.throughput_lasting_duration_warning != null}, lasting='${var.throughput_lasting_duration_warning}', at_least=${var.throughput_at_least_percentage_warning}%{endif}) and (not when(signal >= ${var.throughput_threshold_minor}%{if var.throughput_lasting_duration_minor != null}, lasting='${var.throughput_lasting_duration_minor}', at_least=${var.throughput_at_least_percentage_minor}%{endif}))).publish('WARN')
EOF
