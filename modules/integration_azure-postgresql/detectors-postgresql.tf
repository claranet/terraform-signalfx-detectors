...
resource "signalfx_detector" "no_connection" {
  ...
  rule {
    ...
    runbook_url           = coalesce(var.no_connection_runbook_url, var.runbook_url)
...
resource "signalfx_detector" "storage_usage" {
  ...
  rule {
    ...
    runbook_url           = coalesce(var.storage_usage_runbook_url, var.runbook_url)
...
resource "signalfx_detector" "io_consumption" {
  ...
  rule {
    ...
    runbook_url           = coalesce(var.io_consumption_runbook_url, var.runbook_url)
...
resource "signalfx_detector" "memory_usage" {
  ...
  rule {
    ...
    runbook_url           = coalesce(var.memory_usage_runbook_url, var.runbook_url)
...
resource "signalfx_detector" "serverlog_storage_usage" {
  ...
  rule {
    ...
    runbook_url           = coalesce(var.serverlog_storage_usage_runbook_url, var.runbook_url)
