...
# serverlog_storage_usage detector
...
variable "serverlog_storage_usage_transformation_function" {
  description = "Transformation function for serverlog_storage_usage detector (i.e. \".mean(over='5m')\")"
  type        = string
  default     = ""
}
...
variable "serverlog_storage_usage_runbook_url" {
  description = "URL like SignalFx dashboard or wiki page which can help to troubleshoot the incident cause"
  type        = string
  default     = ""
}
...
variable "serverlog_storage_usage_threshold_critical" {
  description = "Critical threshold for serverlog_storage_usage detector in %"
  type        = number
  default     = 90
}

variable "serverlog_storage_usage_lasting_duration_critical" {
  description = "Minimum duration that conditions must be true before raising alert"
  type        = string
  default     = "15m"
}

variable "serverlog_storage_usage_at_least_percentage_critical" {
  description = "Percentage of lasting that conditions must be true before raising alert (>= 0.0 and <= 1.0)"
  type        = number
  default     = 1
}
variable "serverlog_storage_usage_threshold_major" {
  description = "Major threshold for serverlog_storage_usage detector in %"
  type        = number
  default     = 80
}

variable "serverlog_storage_usage_lasting_duration_major" {
  description = "Minimum duration that conditions must be true before raising alert"
  type        = string
  default     = "15m"
}

variable "serverlog_storage_usage_at_least_percentage_major" {
  description = "Percentage of lasting that conditions must be true before raising alert (>= 0.0 and <= 1.0)"
  type        = number
  default     = 1
}
