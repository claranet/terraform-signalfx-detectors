# AZURE-VIRTUAL-NETWORK-GATEWAY SignalFx detectors
...
```hcl
module "signalfx-detectors-integration-azure-virtual-network-gateway" {
  source = "github.com/claranet/terraform-signalfx-detectors.git//modules/integration_azure-virtual-network-gateway?ref={revision}"
