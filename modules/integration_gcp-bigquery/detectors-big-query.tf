...
EOF
  ...
  rule {
    ...
    runbook_url           = var.concurrent_queries_runbook_url
...
EOF
  ...
  rule {
    ...
    runbook_url           = var.execution_time_runbook_url
...
EOF
  ...
  rule {
    ...
    runbook_url           = var.scanned_bytes_runbook_url
...
EOF
  ...
  rule {
    ...
    runbook_url           = var.scanned_bytes_billed_runbook_url
...
EOF
  ...
  rule {
    ...
    runbook_url           = var.available_slots_runbook_url
...
EOF
  ...
  rule {
    ...
    runbook_url           = var.stored_bytes_runbook_url
...
EOF
  ...
  rule {
    ...
    runbook_url           = var.table_count_runbook_url
...
EOF
  ...
  rule {
    ...
    runbook_url           = var.uploaded_bytes_runbook_url
...
EOF
  ...
  rule {
    ...
    runbook_url           = var.uploaded_bytes_billed_runbook_url
