...
EOF
  ...
  rule {
    ...
    notifications         = try(coalescelist(lookup(var.concurrent_queries_notifications, "critical", []), var.notifications.critical), null)
  ...
  rule {
    ...
    notifications         = try(coalescelist(lookup(var.concurrent_queries_notifications, "major", []), var.notifications.major), null)
    runbook_url           = try(coalesce(var.concurrent_queries_runbook_url, var.runbook_url), "")
    tip                   = var.concurrent_queries_tip
    parameterized_subject = var.message_subject == "" ? local.rule_subject : var.message_subject
    parameterized_body    = var.message_body == "" ? local.rule_body : var.message_body
...
EOF
  ...
  rule {
    ...
    notifications         = try(coalescelist(lookup(var.execution_time_notifications, "critical", []), var.notifications.critical), null)
  ...
  rule {
    ...
    notifications         = try(coalescelist(lookup(var.execution_time_notifications, "major", []), var.notifications.major), null)
    runbook_url           = try(coalesce(var.execution_time_runbook_url, var.runbook_url), "")
    tip                   = var.execution_time_tip
    parameterized_subject = var.message_subject == "" ? local.rule_subject : var.message_subject
    parameterized_body    = var.message_body == "" ? local.rule_body : var.message_body
...
EOF
  ...
  rule {
    ...
    notifications         = try(coalescelist(lookup(var.scanned_bytes_notifications, "critical", []), var.notifications.critical), null)
  ...
  rule {
    ...
    notifications         = try(coalescelist(lookup(var.scanned_bytes_notifications, "major", []), var.notifications.major), null)
    runbook_url           = try(coalesce(var.scanned_bytes_runbook_url, var.runbook_url), "")
    tip                   = var.scanned_bytes_tip
    parameterized_subject = var.message_subject == "" ? local.rule_subject : var.message_subject
    parameterized_body    = var.message_body == "" ? local.rule_body : var.message_body
...
EOF
  ...
  rule {
    ...
    notifications         = try(coalescelist(lookup(var.scanned_bytes_billed_notifications, "critical", []), var.notifications.critical), null)
  ...
  rule {
    ...
    notifications         = try(coalescelist(lookup(var.scanned_bytes_billed_notifications, "major", []), var.notifications.major), null)
    runbook_url           = try(coalesce(var.scanned_bytes_billed_runbook_url, var.runbook_url), "")
    tip                   = var.scanned_bytes_billed_tip
    parameterized_subject = var.message_subject == "" ? local.rule_subject : var.message_subject
    parameterized_body    = var.message_body == "" ? local.rule_body : var.message_body
...
EOF
  ...
  rule {
    ...
    notifications         = try(coalescelist(lookup(var.available_slots_notifications, "critical", []), var.notifications.critical), null)
  ...
  rule {
    ...
    notifications         = try(coalescelist(lookup(var.available_slots_notifications, "major", []), var.notifications.major), null)
    runbook_url           = try(coalesce(var.available_slots_runbook_url, var.runbook_url), "")
    tip                   = var.available_slots_tip
    parameterized_subject = var.message_subject == "" ? local.rule_subject : var.message_subject
    parameterized_body    = var.message_body == "" ? local.rule_body : var.message_body
...
EOF
  ...
  rule {
    ...
    notifications         = try(coalescelist(lookup(var.stored_bytes_notifications, "critical", []), var.notifications.critical), null)
  ...
  rule {
    ...
    notifications         = try(coalescelist(lookup(var.stored_bytes_notifications, "major", []), var.notifications.major), null)
    runbook_url           = try(coalesce(var.stored_bytes_runbook_url, var.runbook_url), "")
    tip                   = var.stored_bytes_tip
    parameterized_subject = var.message_subject == "" ? local.rule_subject : var.message_subject
    parameterized_body    = var.message_body == "" ? local.rule_body : var.message_body
...
EOF
  ...
  rule {
    ...
    notifications         = try(coalescelist(lookup(var.table_count_notifications, "critical", []), var.notifications.critical), null)
  ...
  rule {
    ...
    notifications         = try(coalescelist(lookup(var.table_count_notifications, "major", []), var.notifications.major), null)
    runbook_url           = try(coalesce(var.table_count_runbook_url, var.runbook_url), "")
    tip                   = var.table_count_tip
    parameterized_subject = var.message_subject == "" ? local.rule_subject : var.message_subject
    parameterized_body    = var.message_body == "" ? local.rule_body : var.message_body
...
EOF
  ...
  rule {
    ...
    notifications         = try(coalescelist(lookup(var.uploaded_bytes_notifications, "critical", []), var.notifications.critical), null)
  ...
  rule {
    ...
    notifications         = try(coalescelist(lookup(var.uploaded_bytes_notifications, "major", []), var.notifications.major), null)
    runbook_url           = try(coalesce(var.uploaded_bytes_runbook_url, var.runbook_url), "")
    tip                   = var.uploaded_bytes_tip
    parameterized_subject = var.message_subject == "" ? local.rule_subject : var.message_subject
    parameterized_body    = var.message_body == "" ? local.rule_body : var.message_body
...
EOF
  ...
  rule {
    ...
    notifications         = try(coalescelist(lookup(var.uploaded_bytes_billed_notifications, "critical", []), var.notifications.critical), null)
  ...
  rule {
    ...
    notifications         = try(coalescelist(lookup(var.uploaded_bytes_billed_notifications, "major", []), var.notifications.major), null)
    runbook_url           = try(coalesce(var.uploaded_bytes_billed_runbook_url, var.runbook_url), "")
    tip                   = var.uploaded_bytes_billed_tip
    parameterized_subject = var.message_subject == "" ? local.rule_subject : var.message_subject
    parameterized_body    = var.message_body == "" ? local.rule_body : var.message_body
