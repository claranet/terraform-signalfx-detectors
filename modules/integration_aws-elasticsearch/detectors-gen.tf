...
resource "signalfx_detector" "jvm_memory_pressure" {
  ...
  program_text = <<-EOF
    ...
    detect(when(signal > ${var.jvm_memory_pressure_threshold_critical}%{if var.jvm_memory_pressure_lasting_duration_critical != null}, lasting='${var.jvm_memory_pressure_lasting_duration_critical}', at_least=${var.jvm_memory_pressure_at_least_percentage_critical}%{endif})).publish('CRIT')
    detect(when(signal > ${var.jvm_memory_pressure_threshold_major}%{if var.jvm_memory_pressure_lasting_duration_major != null}, lasting='${var.jvm_memory_pressure_lasting_duration_major}', at_least=${var.jvm_memory_pressure_at_least_percentage_major}%{endif}) and (not when(signal > ${var.jvm_memory_pressure_threshold_critical}%{if var.jvm_memory_pressure_lasting_duration_critical != null}, lasting='${var.jvm_memory_pressure_lasting_duration_critical}', at_least=${var.jvm_memory_pressure_at_least_percentage_critical}%{endif}))).publish('MAJOR')
EOF
...
resource "signalfx_detector" "fourxx_http_response" {
  ...
  program_text = <<-EOF
    ...
    detect(when(signal > ${var.fourxx_http_response_threshold_critical}%{if var.fourxx_http_response_lasting_duration_critical != null}, lasting='${var.fourxx_http_response_lasting_duration_critical}', at_least=${var.fourxx_http_response_at_least_percentage_critical}%{endif})).publish('CRIT')
    detect(when(signal > ${var.fourxx_http_response_threshold_major}%{if var.fourxx_http_response_lasting_duration_major != null}, lasting='${var.fourxx_http_response_lasting_duration_major}', at_least=${var.fourxx_http_response_at_least_percentage_major}%{endif}) and (not when(signal > ${var.fourxx_http_response_threshold_critical}%{if var.fourxx_http_response_lasting_duration_critical != null}, lasting='${var.fourxx_http_response_lasting_duration_critical}', at_least=${var.fourxx_http_response_at_least_percentage_critical}%{endif}))).publish('MAJOR')
EOF
...
resource "signalfx_detector" "fivexx_http_response" {
  ...
  program_text = <<-EOF
    ...
    detect(when(opensearch_signal > ${var.fivexx_http_response_threshold_opensearch_critical}%{if var.fivexx_http_response_lasting_duration_opensearch_critical != null}, lasting='${var.fivexx_http_response_lasting_duration_opensearch_critical}', at_least=${var.fivexx_http_response_at_least_percentage_opensearch_critical}%{endif})).publish('OPENSEARCH_CRIT')
    detect(when(opensearch_signal > ${var.fivexx_http_response_threshold_opensearch_major}%{if var.fivexx_http_response_lasting_duration_opensearch_major != null}, lasting='${var.fivexx_http_response_lasting_duration_opensearch_major}', at_least=${var.fivexx_http_response_at_least_percentage_opensearch_major}%{endif}) and (not when(opensearch_signal > ${var.fivexx_http_response_threshold_opensearch_critical}%{if var.fivexx_http_response_lasting_duration_opensearch_critical != null}, lasting='${var.fivexx_http_response_lasting_duration_opensearch_critical}', at_least=${var.fivexx_http_response_at_least_percentage_opensearch_critical}%{endif}))).publish('OPENSEARCH_MAJOR')
    detect(when(elasticsearch_signal > ${var.fivexx_http_response_threshold_elasticsearch_critical}%{if var.fivexx_http_response_lasting_duration_elasticsearch_critical != null}, lasting='${var.fivexx_http_response_lasting_duration_elasticsearch_critical}', at_least=${var.fivexx_http_response_at_least_percentage_elasticsearch_critical}%{endif})).publish('ELASTICSEARCH_CRIT')
    detect(when(elasticsearch_signal > ${var.fivexx_http_response_threshold_elasticsearch_major}%{if var.fivexx_http_response_lasting_duration_elasticsearch_major != null}, lasting='${var.fivexx_http_response_lasting_duration_elasticsearch_major}', at_least=${var.fivexx_http_response_at_least_percentage_elasticsearch_major}%{endif}) and (not when(elasticsearch_signal > ${var.fivexx_http_response_threshold_elasticsearch_critical}%{if var.fivexx_http_response_lasting_duration_elasticsearch_critical != null}, lasting='${var.fivexx_http_response_lasting_duration_elasticsearch_critical}', at_least=${var.fivexx_http_response_at_least_percentage_elasticsearch_critical}%{endif}))).publish('ELASTICSEARCH_MAJOR')
EOF
...
resource "signalfx_detector" "shard_count" {
  ...
  program_text = <<-EOF
    ...
    detect(when(signal > ${var.shard_count_threshold_critical}%{if var.shard_count_lasting_duration_critical != null}, lasting='${var.shard_count_lasting_duration_critical}', at_least=${var.shard_count_at_least_percentage_critical}%{endif})).publish('CRIT')
    detect(when(signal > ${var.shard_count_threshold_major}%{if var.shard_count_lasting_duration_major != null}, lasting='${var.shard_count_lasting_duration_major}', at_least=${var.shard_count_at_least_percentage_major}%{endif}) and (not when(signal > ${var.shard_count_threshold_critical}%{if var.shard_count_lasting_duration_critical != null}, lasting='${var.shard_count_lasting_duration_critical}', at_least=${var.shard_count_at_least_percentage_critical}%{endif}))).publish('MAJOR')
EOF
...
resource "signalfx_detector" "cluster_status" {
  ...
  program_text = <<-EOF
    ...
    detect(when(red >= ${var.cluster_status_threshold_critical}%{if var.cluster_status_lasting_duration_critical != null}, lasting='${var.cluster_status_lasting_duration_critical}', at_least=${var.cluster_status_at_least_percentage_critical}%{endif})).publish('CRIT')
    detect(when(yellow >= ${var.cluster_status_threshold_major}%{if var.cluster_status_lasting_duration_major != null}, lasting='${var.cluster_status_lasting_duration_major}', at_least=${var.cluster_status_at_least_percentage_major}%{endif})).publish('MAJOR')
EOF
...
resource "signalfx_detector" "free_space" {
  ...
  program_text = <<-EOF
    ...
    detect(when(signal < ${var.free_space_threshold_major}%{if var.free_space_lasting_duration_major != null}, lasting='${var.free_space_lasting_duration_major}', at_least=${var.free_space_at_least_percentage_major}%{endif}) and (not when(signal < ${var.free_space_threshold_critical}%{if var.free_space_lasting_duration_critical != null}, lasting='${var.free_space_lasting_duration_critical}', at_least=${var.free_space_at_least_percentage_critical}%{endif}))).publish('MAJOR')
    detect(when(signal < ${var.free_space_threshold_critical}%{if var.free_space_lasting_duration_critical != null}, lasting='${var.free_space_lasting_duration_critical}', at_least=${var.free_space_at_least_percentage_critical}%{endif})).publish('CRIT')
EOF
...
resource "signalfx_detector" "ultrawarm_free_space" {
  ...
  program_text = <<-EOF
    ...
    detect(when(signal < ${var.ultrawarm_free_space_threshold_major}%{if var.ultrawarm_free_space_lasting_duration_major != null}, lasting='${var.ultrawarm_free_space_lasting_duration_major}', at_least=${var.ultrawarm_free_space_at_least_percentage_major}%{endif}) and (not when(signal < ${var.ultrawarm_free_space_threshold_critical}%{if var.ultrawarm_free_space_lasting_duration_critical != null}, lasting='${var.ultrawarm_free_space_lasting_duration_critical}', at_least=${var.ultrawarm_free_space_at_least_percentage_critical}%{endif}))).publish('MAJOR')
    detect(when(signal < ${var.ultrawarm_free_space_threshold_critical}%{if var.ultrawarm_free_space_lasting_duration_critical != null}, lasting='${var.ultrawarm_free_space_lasting_duration_critical}', at_least=${var.ultrawarm_free_space_at_least_percentage_critical}%{endif})).publish('CRIT')
EOF
...
resource "signalfx_detector" "cluster_cpu" {
  ...
  program_text = <<-EOF
    ...
    detect(when(signal > ${var.cluster_cpu_threshold_major}%{if var.cluster_cpu_lasting_duration_major != null}, lasting='${var.cluster_cpu_lasting_duration_major}', at_least=${var.cluster_cpu_at_least_percentage_major}%{endif}) and (not when(signal > ${var.cluster_cpu_threshold_critical}%{if var.cluster_cpu_lasting_duration_critical != null}, lasting='${var.cluster_cpu_lasting_duration_critical}', at_least=${var.cluster_cpu_at_least_percentage_critical}%{endif}))).publish('MAJOR')
    detect(when(signal > ${var.cluster_cpu_threshold_critical}%{if var.cluster_cpu_lasting_duration_critical != null}, lasting='${var.cluster_cpu_lasting_duration_critical}', at_least=${var.cluster_cpu_at_least_percentage_critical}%{endif})).publish('CRIT')
EOF
...
resource "signalfx_detector" "master_cpu" {
  ...
  program_text = <<-EOF
    ...
    detect(when(signal > ${var.master_cpu_threshold_major}%{if var.master_cpu_lasting_duration_major != null}, lasting='${var.master_cpu_lasting_duration_major}', at_least=${var.master_cpu_at_least_percentage_major}%{endif}) and (not when(signal > ${var.master_cpu_threshold_critical}%{if var.master_cpu_lasting_duration_critical != null}, lasting='${var.master_cpu_lasting_duration_critical}', at_least=${var.master_cpu_at_least_percentage_critical}%{endif}))).publish('MAJOR')
    detect(when(signal > ${var.master_cpu_threshold_critical}%{if var.master_cpu_lasting_duration_critical != null}, lasting='${var.master_cpu_lasting_duration_critical}', at_least=${var.master_cpu_at_least_percentage_critical}%{endif})).publish('CRIT')
EOF
