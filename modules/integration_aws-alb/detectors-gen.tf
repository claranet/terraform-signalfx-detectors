...
resource "signalfx_detector" "alb_5xx" {
  ...
  program_text = <<-EOF
    ...
    detect(when(signal > ${var.alb_5xx_threshold_critical}%{if var.alb_5xx_lasting_duration_critical != null}, lasting='${var.alb_5xx_lasting_duration_critical}', at_least=${var.alb_5xx_at_least_percentage_critical}%{endif}) and when(requests > ${var.minimum_traffic})).publish('CRIT')
    detect(when(signal > ${var.alb_5xx_threshold_major}%{if var.alb_5xx_lasting_duration_major != null}, lasting='${var.alb_5xx_lasting_duration_major}', at_least=${var.alb_5xx_at_least_percentage_major}%{endif}) and when(requests > ${var.minimum_traffic}) and (not when(signal > ${var.alb_5xx_threshold_critical}%{if var.alb_5xx_lasting_duration_critical != null}, lasting='${var.alb_5xx_lasting_duration_critical}', at_least=${var.alb_5xx_at_least_percentage_critical}%{endif}) and when(requests > ${var.minimum_traffic}))).publish('MAJOR')
EOF
...
resource "signalfx_detector" "alb_4xx" {
  ...
  program_text = <<-EOF
    ...
    signal = (errors/requests).scale(100).fill(value=0).publish('signal')
    detect(when(signal > ${var.alb_4xx_threshold_critical}%{if var.alb_4xx_lasting_duration_critical != null}, lasting='${var.alb_4xx_lasting_duration_critical}', at_least=${var.alb_4xx_at_least_percentage_critical}%{endif}) and when(requests > ${var.minimum_traffic})).publish('CRIT')
    detect(when(signal > ${var.alb_4xx_threshold_major}%{if var.alb_4xx_lasting_duration_major != null}, lasting='${var.alb_4xx_lasting_duration_major}', at_least=${var.alb_4xx_at_least_percentage_major}%{endif}) and when(requests > ${var.minimum_traffic}) and (not when(signal > ${var.alb_4xx_threshold_critical}%{if var.alb_4xx_lasting_duration_critical != null}, lasting='${var.alb_4xx_lasting_duration_critical}', at_least=${var.alb_4xx_at_least_percentage_critical}%{endif}) and when(requests > ${var.minimum_traffic}))).publish('MAJOR')
    detect(when(signal > ${var.alb_4xx_threshold_minor}%{if var.alb_4xx_lasting_duration_minor != null}, lasting='${var.alb_4xx_lasting_duration_minor}', at_least=${var.alb_4xx_at_least_percentage_minor}%{endif}) and when(requests > ${var.minimum_traffic}) and (not when(signal > ${var.alb_4xx_threshold_major}%{if var.alb_4xx_lasting_duration_major != null}, lasting='${var.alb_4xx_lasting_duration_major}', at_least=${var.alb_4xx_at_least_percentage_major}%{endif}) and when(requests > ${var.minimum_traffic}))).publish('MINOR')
EOF
...
resource "signalfx_detector" "target_5xx" {
  ...
  program_text = <<-EOF
    ...
    signal = (errors/requests).scale(100).fill(value=0).publish('signal')
    detect(when(signal > ${var.target_5xx_threshold_critical}%{if var.target_5xx_lasting_duration_critical != null}, lasting='${var.target_5xx_lasting_duration_critical}', at_least=${var.target_5xx_at_least_percentage_critical}%{endif}) and when(requests > ${var.minimum_traffic})).publish('CRIT')
    detect(when(signal > ${var.target_5xx_threshold_major}%{if var.target_5xx_lasting_duration_major != null}, lasting='${var.target_5xx_lasting_duration_major}', at_least=${var.target_5xx_at_least_percentage_major}%{endif}) and when(requests > ${var.minimum_traffic}) and (not when(signal > ${var.target_5xx_threshold_critical}%{if var.target_5xx_lasting_duration_critical != null}, lasting='${var.target_5xx_lasting_duration_critical}', at_least=${var.target_5xx_at_least_percentage_critical}%{endif}) and when(requests > ${var.minimum_traffic}))).publish('MAJOR')
EOF
...
resource "signalfx_detector" "target_4xx" {
  ...
  program_text = <<-EOF
    ...
    signal = (errors/requests).scale(100).fill(value=0).publish('signal')
    detect(when(signal > ${var.target_4xx_threshold_critical}%{if var.target_4xx_lasting_duration_critical != null}, lasting='${var.target_4xx_lasting_duration_critical}', at_least=${var.target_4xx_at_least_percentage_critical}%{endif}) and when(requests > ${var.minimum_traffic})).publish('CRIT')
    detect(when(signal > ${var.target_4xx_threshold_major}%{if var.target_4xx_lasting_duration_major != null}, lasting='${var.target_4xx_lasting_duration_major}', at_least=${var.target_4xx_at_least_percentage_major}%{endif}) and when(requests > ${var.minimum_traffic}) and (not when(signal > ${var.target_4xx_threshold_critical}%{if var.target_4xx_lasting_duration_critical != null}, lasting='${var.target_4xx_lasting_duration_critical}', at_least=${var.target_4xx_at_least_percentage_critical}%{endif}) and when(requests > ${var.minimum_traffic}))).publish('MAJOR')
    detect(when(signal > ${var.target_4xx_threshold_minor}%{if var.target_4xx_lasting_duration_minor != null}, lasting='${var.target_4xx_lasting_duration_minor}', at_least=${var.target_4xx_at_least_percentage_minor}%{endif}) and when(requests > ${var.minimum_traffic}) and (not when(signal > ${var.target_4xx_threshold_major}%{if var.target_4xx_lasting_duration_major != null}, lasting='${var.target_4xx_lasting_duration_major}', at_least=${var.target_4xx_at_least_percentage_major}%{endif}) and when(requests > ${var.minimum_traffic}))).publish('MINOR')
EOF
