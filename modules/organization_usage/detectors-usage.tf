...
EOF
  ...
  rule {
    ...
    runbook_url           = var.hosts_limit_runbook_url
...
EOF
  ...
  rule {
    ...
    runbook_url           = var.containers_limit_runbook_url
...
EOF
  ...
  rule {
    ...
    runbook_url           = var.custom_metrics_limit_runbook_url
...
EOF
  ...
  rule {
    ...
    runbook_url           = var.containers_ratio_runbook_url
...
EOF
  ...
  rule {
    ...
    runbook_url           = var.custom_metrics_ratio_runbook_url
