# AZURE-SEARCH SignalFx detectors
...
```hcl
module "signalfx-detectors-cloud-azure-azure-search" {
  source = "github.com/claranet/terraform-signalfx-detectors.git//cloud/azure/azure-search?ref={revision}"
