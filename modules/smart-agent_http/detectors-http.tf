...
EOF
  ...
  rule {
    ...
    runbook_url           = var.http_code_matched_runbook_url
...
EOF
  ...
  rule {
    ...
    runbook_url           = var.http_regex_matched_runbook_url
...
EOF
  ...
  rule {
    ...
    runbook_url           = var.http_response_time_runbook_url
...
EOF
  ...
  rule {
    ...
    runbook_url           = var.http_content_length_runbook_url
...
EOF
  ...
  rule {
    ...
    runbook_url           = var.certificate_expiration_date_runbook_url
...
EOF
  ...
  rule {
    ...
    runbook_url           = var.invalid_tls_certificate_runbook_url
