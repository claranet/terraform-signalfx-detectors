...
EOF
  ...
  rule {
    ...
    runbook_url           = coalesce(var.http_code_matched_runbook_url, var.runbook_url)
...
EOF
  ...
  rule {
    ...
    runbook_url           = coalesce(var.http_regex_matched_runbook_url, var.runbook_url)
...
EOF
  ...
  rule {
    ...
    runbook_url           = coalesce(var.http_response_time_runbook_url, var.runbook_url)
...
EOF
  ...
  rule {
    ...
    runbook_url           = coalesce(var.http_content_length_runbook_url, var.runbook_url)
...
EOF
  ...
  rule {
    ...
    runbook_url           = coalesce(var.certificate_expiration_date_runbook_url, var.runbook_url)
...
EOF
  ...
  rule {
    ...
    runbook_url           = coalesce(var.invalid_tls_certificate_runbook_url, var.runbook_url)
