...
output "cluster_unassigned_shards" {
  description = "Detector resource for cluster_unassigned_shards"
  value       = signalfx_detector.cluster_unassigned_shards
}
...
output "jvm_heap_memory_usage" {
  description = "Detector resource for jvm_heap_memory_usage"
  value       = signalfx_detector.jvm_heap_memory_usage
}

output "jvm_memory_old_usage" {
  description = "Detector resource for jvm_memory_old_usage"
  value       = signalfx_detector.jvm_memory_old_usage
}

output "jvm_memory_young_usage" {
  description = "Detector resource for jvm_memory_young_usage"
