# SERVICE-BUS SignalFx detectors
...
```hcl
module "signalfx-detectors-cloud-azure-service-bus" {
  source = "github.com/claranet/terraform-signalfx-detectors.git//cloud/azure/service-bus?ref={revision}"
