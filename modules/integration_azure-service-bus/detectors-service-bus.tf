...
resource "signalfx_detector" "active_connections" {
  ...
  rule {
    ...
    runbook_url           = coalesce(var.active_connections_runbook_url, var.runbook_url)
...
resource "signalfx_detector" "user_errors" {
  ...
  rule {
    ...
    runbook_url           = coalesce(var.user_errors_runbook_url, var.runbook_url)
...
resource "signalfx_detector" "server_errors" {
  ...
  rule {
    ...
    runbook_url           = coalesce(var.server_errors_runbook_url, var.runbook_url)
...
EOF
  ...
  rule {
    ...
    runbook_url           = coalesce(var.throttled_requests_runbook_url, var.runbook_url)
