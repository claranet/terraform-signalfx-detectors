...
EOF
  ...
  rule {
    ...
    runbook_url           = var.deadlocks_runbook_url
...
EOF
  ...
  rule {
    ...
    runbook_url           = var.hit_ratio_runbook_url
...
EOF
  ...
  rule {
    ...
    runbook_url           = var.rollbacks_runbook_url
...
EOF
  ...
  rule {
    ...
    runbook_url           = var.conflicts_runbook_url
...
EOF
  ...
  rule {
    ...
    runbook_url           = var.max_connections_runbook_url
...
EOF
  ...
  rule {
    ...
    runbook_url           = var.replication_state_runbook_url
