...
resource "signalfx_detector" "response_time" {
  ...
  program_text = <<-EOF
    ...
    detect(when(signal > ${var.response_time_threshold_critical}%{if var.response_time_lasting_duration_critical != null}, lasting='${var.response_time_lasting_duration_critical}', at_least=${var.response_time_at_least_percentage_critical}%{endif})).publish('CRIT')
    detect(when(signal > ${var.response_time_threshold_major}%{if var.response_time_lasting_duration_major != null}, lasting='${var.response_time_lasting_duration_major}', at_least=${var.response_time_at_least_percentage_major}%{endif}) and (not when(signal > ${var.response_time_threshold_critical}%{if var.response_time_lasting_duration_critical != null}, lasting='${var.response_time_lasting_duration_critical}', at_least=${var.response_time_at_least_percentage_critical}%{endif}))).publish('MAJOR')
EOF
...
resource "signalfx_detector" "http_5xx_error_rate" {
  ...
  program_text = <<-EOF
    ...
    detect(when(signal > ${var.http_5xx_error_rate_threshold_major}%{if var.http_5xx_error_rate_lasting_duration_major != null}, lasting='${var.http_5xx_error_rate_lasting_duration_major}', at_least=${var.http_5xx_error_rate_at_least_percentage_major}%{endif})).publish('MAJOR')
    detect(when(signal > ${var.http_5xx_error_rate_threshold_minor}%{if var.http_5xx_error_rate_lasting_duration_minor != null}, lasting='${var.http_5xx_error_rate_lasting_duration_minor}', at_least=${var.http_5xx_error_rate_at_least_percentage_minor}%{endif}) and (not when(signal > ${var.http_5xx_error_rate_threshold_major}%{if var.http_5xx_error_rate_lasting_duration_major != null}, lasting='${var.http_5xx_error_rate_lasting_duration_major}', at_least=${var.http_5xx_error_rate_at_least_percentage_major}%{endif}))).publish('MINOR')
EOF
...
resource "signalfx_detector" "http_4xx_error_rate" {
  ...
  program_text = <<-EOF
    ...
    detect(when(signal > ${var.http_4xx_error_rate_threshold_major}%{if var.http_4xx_error_rate_lasting_duration_major != null}, lasting='${var.http_4xx_error_rate_lasting_duration_major}', at_least=${var.http_4xx_error_rate_at_least_percentage_major}%{endif})).publish('MAJOR')
    detect(when(signal > ${var.http_4xx_error_rate_threshold_minor}%{if var.http_4xx_error_rate_lasting_duration_minor != null}, lasting='${var.http_4xx_error_rate_lasting_duration_minor}', at_least=${var.http_4xx_error_rate_at_least_percentage_minor}%{endif}) and (not when(signal > ${var.http_4xx_error_rate_threshold_major}%{if var.http_4xx_error_rate_lasting_duration_major != null}, lasting='${var.http_4xx_error_rate_lasting_duration_major}', at_least=${var.http_4xx_error_rate_at_least_percentage_major}%{endif}))).publish('MINOR')
EOF
...
resource "signalfx_detector" "http_success_status_rate" {
  ...
  program_text = <<-EOF
    ...
    detect(when(signal < ${var.http_success_status_rate_threshold_major}%{if var.http_success_status_rate_lasting_duration_major != null}, lasting='${var.http_success_status_rate_lasting_duration_major}', at_least=${var.http_success_status_rate_at_least_percentage_major}%{endif})).publish('MAJOR')
    detect(when(signal < ${var.http_success_status_rate_threshold_minor}%{if var.http_success_status_rate_lasting_duration_minor != null}, lasting='${var.http_success_status_rate_lasting_duration_minor}', at_least=${var.http_success_status_rate_at_least_percentage_minor}%{endif}) and (not when(signal < ${var.http_success_status_rate_threshold_major}%{if var.http_success_status_rate_lasting_duration_major != null}, lasting='${var.http_success_status_rate_lasting_duration_major}', at_least=${var.http_success_status_rate_at_least_percentage_major}%{endif}))).publish('MINOR')
EOF
