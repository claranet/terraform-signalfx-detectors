...
resource "signalfx_detector" "cpu" {
  ...
  program_text = <<-EOF
    signal = data('CPUUtilization', filter=${module.filtering.signalflow}, extrapolation='zero')${var.cpu_aggregation_function}${var.cpu_transformation_function}.publish('signal')
