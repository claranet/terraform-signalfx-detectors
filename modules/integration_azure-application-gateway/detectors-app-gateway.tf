...
resource "signalfx_detector" "total_requests" {
  ...
  rule {
    ...
    runbook_url           = coalesce(var.total_requests_runbook_url, var.runbook_url)
...
resource "signalfx_detector" "backend_connect_time" {
  ...
  rule {
    ...
    runbook_url           = coalesce(var.backend_connect_time_runbook_url, var.runbook_url)
...
resource "signalfx_detector" "failed_requests" {
  ...
  rule {
    ...
    runbook_url           = coalesce(var.failed_requests_runbook_url, var.runbook_url)
...
resource "signalfx_detector" "unhealthy_host_ratio" {
  ...
  rule {
    ...
    runbook_url           = coalesce(var.unhealthy_host_ratio_runbook_url, var.runbook_url)
...
resource "signalfx_detector" "http_4xx_errors" {
  ...
  rule {
    ...
    runbook_url           = coalesce(var.http_4xx_errors_runbook_url, var.runbook_url)
...
resource "signalfx_detector" "http_5xx_errors" {
  ...
  rule {
    ...
    runbook_url           = coalesce(var.http_5xx_errors_runbook_url, var.runbook_url)
...
resource "signalfx_detector" "backend_http_4xx_errors" {
  ...
  rule {
    ...
    runbook_url           = coalesce(var.backend_http_4xx_errors_runbook_url, var.runbook_url)
...
resource "signalfx_detector" "backend_http_5xx_errors" {
  ...
  rule {
    ...
    runbook_url           = coalesce(var.backend_http_5xx_errors_runbook_url, var.runbook_url)
