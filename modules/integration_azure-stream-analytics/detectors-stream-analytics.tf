...
resource "signalfx_detector" "su_utilization" {
  ...
  rule {
    ...
    runbook_url           = var.su_utilization_runbook_url
...
resource "signalfx_detector" "failed_function_requests" {
  ...
  rule {
    ...
    runbook_url           = var.failed_function_requests_runbook_url
...
resource "signalfx_detector" "conversion_errors" {
  ...
  rule {
    ...
    runbook_url           = var.conversion_errors_runbook_url
...
resource "signalfx_detector" "runtime_errors" {
  ...
  rule {
    ...
    runbook_url           = var.runtime_errors_runbook_url
