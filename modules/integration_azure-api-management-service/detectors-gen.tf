...
resource "signalfx_detector" "duration_of_gateway_request" {
  ...
  program_text = <<-EOF
    ...
    detect(when(signal > ${var.duration_of_gateway_request_threshold_critical}, lasting=%{if var.duration_of_gateway_request_lasting_duration_critical == null}None%{else}'${var.duration_of_gateway_request_lasting_duration_critical}'%{endif}, at_least=${var.duration_of_gateway_request_at_least_percentage_critical})).publish('CRIT')
    detect(when(signal > ${var.duration_of_gateway_request_threshold_major}, lasting=%{if var.duration_of_gateway_request_lasting_duration_major == null}None%{else}'${var.duration_of_gateway_request_lasting_duration_major}'%{endif}, at_least=${var.duration_of_gateway_request_at_least_percentage_major}) and (not when(signal > ${var.duration_of_gateway_request_threshold_critical}, lasting=%{if var.duration_of_gateway_request_lasting_duration_critical == null}None%{else}'${var.duration_of_gateway_request_lasting_duration_critical}'%{endif}, at_least=${var.duration_of_gateway_request_at_least_percentage_critical}))).publish('MAJOR')
EOF
...
resource "signalfx_detector" "duration_of_backend_request" {
  ...
  program_text = <<-EOF
    ...
    detect(when(signal > ${var.duration_of_backend_request_threshold_critical}, lasting=%{if var.duration_of_backend_request_lasting_duration_critical == null}None%{else}'${var.duration_of_backend_request_lasting_duration_critical}'%{endif}, at_least=${var.duration_of_backend_request_at_least_percentage_critical})).publish('CRIT')
    detect(when(signal > ${var.duration_of_backend_request_threshold_major}, lasting=%{if var.duration_of_backend_request_lasting_duration_major == null}None%{else}'${var.duration_of_backend_request_lasting_duration_major}'%{endif}, at_least=${var.duration_of_backend_request_at_least_percentage_major}) and (not when(signal > ${var.duration_of_backend_request_threshold_critical}, lasting=%{if var.duration_of_backend_request_lasting_duration_critical == null}None%{else}'${var.duration_of_backend_request_lasting_duration_critical}'%{endif}, at_least=${var.duration_of_backend_request_at_least_percentage_critical}))).publish('MAJOR')
EOF
