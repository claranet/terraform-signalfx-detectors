...
EOF
  ...
  rule {
    ...
    runbook_url           = coalesce(var.error_rate_4xx_runbook_url, var.runbook_url)
...
EOF
  ...
  rule {
    ...
    runbook_url           = coalesce(var.error_rate_5xx_runbook_url, var.runbook_url)
...
EOF
  ...
  rule {
    ...
    runbook_url           = coalesce(var.backend_latency_service_runbook_url, var.runbook_url)
...
EOF
  ...
  rule {
    ...
    runbook_url           = coalesce(var.backend_latency_bucket_runbook_url, var.runbook_url)
...
EOF
  ...
  rule {
    ...
    runbook_url           = coalesce(var.request_count_runbook_url, var.runbook_url)
