...
EOF
  ...
  rule {
    ...
    runbook_url           = var.error_rate_4xx_runbook_url
...
EOF
  ...
  rule {
    ...
    runbook_url           = var.error_rate_5xx_runbook_url
...
EOF
  ...
  rule {
    ...
    runbook_url           = var.backend_latency_service_runbook_url
...
EOF
  ...
  rule {
    ...
    runbook_url           = var.backend_latency_bucket_runbook_url
...
EOF
  ...
  rule {
    ...
    runbook_url           = var.request_count_runbook_url
