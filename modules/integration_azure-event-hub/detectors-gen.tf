resource "signalfx_detector" "throttled_requests" {
  ...
  program_text = <<-EOF
    ...
    detect(when(signal > ${var.throttled_requests_threshold_critical}%{if var.throttled_requests_lasting_duration_critical != "None"}, lasting='${var.throttled_requests_lasting_duration_critical}', at_least=${var.throttled_requests_at_least_percentage_critical}%{endif})).publish('CRIT')
    detect(when(signal > ${var.throttled_requests_threshold_major}%{if var.throttled_requests_lasting_duration_major != "None"}, lasting='${var.throttled_requests_lasting_duration_major}', at_least=${var.throttled_requests_at_least_percentage_major}%{endif}) and not when(signal > ${var.throttled_requests_threshold_critical}%{if var.throttled_requests_lasting_duration_critical != "None"}, lasting='${var.throttled_requests_lasting_duration_critical}', at_least=${var.throttled_requests_at_least_percentage_critical}%{endif})).publish('MAJOR')
    detect(when(signal > ${var.throttled_requests_threshold_warning}%{if var.throttled_requests_lasting_duration_warning != "None"}, lasting='${var.throttled_requests_lasting_duration_warning}', at_least=${var.throttled_requests_at_least_percentage_warning}%{endif}) and not when(signal > ${var.throttled_requests_threshold_major}%{if var.throttled_requests_lasting_duration_major != "None"}, lasting='${var.throttled_requests_lasting_duration_major}', at_least=${var.throttled_requests_at_least_percentage_major}%{endif})).publish('WARN')
EOF
