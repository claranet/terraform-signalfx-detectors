resource "signalfx_detector" "throttled_requests" {
  ...
  program_text = <<-EOF
    ...
    detect(when(signal > ${var.throttled_requests_threshold_critical}, lasting=${var.throttled_requests_lasting_duration_critical == null ? "None" : format("'%s'", var.throttled_requests_lasting_duration_critical)}, at_least=${var.throttled_requests_at_least_percentage_critical})).publish('CRIT')
    detect(when(signal > ${var.throttled_requests_threshold_major}, lasting=${var.throttled_requests_lasting_duration_major == null ? "None" : format("'%s'", var.throttled_requests_lasting_duration_major)}, at_least=${var.throttled_requests_at_least_percentage_major}) and (not when(signal > ${var.throttled_requests_threshold_critical}, lasting=${var.throttled_requests_lasting_duration_critical == null ? "None" : format("'%s'", var.throttled_requests_lasting_duration_critical)}, at_least=${var.throttled_requests_at_least_percentage_critical}))).publish('MAJOR')
    detect(when(signal > ${var.throttled_requests_threshold_warning}, lasting=${var.throttled_requests_lasting_duration_warning == null ? "None" : format("'%s'", var.throttled_requests_lasting_duration_warning)}, at_least=${var.throttled_requests_at_least_percentage_warning}) and (not when(signal > ${var.throttled_requests_threshold_major}, lasting=${var.throttled_requests_lasting_duration_major == null ? "None" : format("'%s'", var.throttled_requests_lasting_duration_major)}, at_least=${var.throttled_requests_at_least_percentage_major}))).publish('WARN')
EOF
