...
```hcl
module "signalfx-detectors-cloud-aws-apigateway" {
  source = "github.com/claranet/terraform-signalfx-detectors.git//cloud/aws/apigateway?ref={revision}"
