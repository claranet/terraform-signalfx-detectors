...
module "signalfx-detectors-integration-aws-apigateway" {
  source = "github.com/claranet/terraform-signalfx-detectors.git//modules/integration_aws-apigateway?ref={revision}"
...
* [Splunk Observability metadata](https://docs.splunk.com/Observability/infrastructure/monitor/aws-infra-metadata.html#amazon-api-gateway-metadata)
