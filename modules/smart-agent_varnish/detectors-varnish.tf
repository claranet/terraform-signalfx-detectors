...
EOF
  ...
  rule {
    ...
    runbook_url           = var.backend_failed_runbook_url
...
EOF
  ...
  rule {
    ...
    runbook_url           = var.threads_number_runbook_url
...
EOF
  ...
  rule {
    ...
    runbook_url           = var.session_dropped_runbook_url
...
EOF
  ...
  rule {
    ...
    runbook_url           = var.cache_hit_rate_runbook_url
