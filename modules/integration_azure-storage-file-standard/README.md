# AZURE-STORAGE-FILE-STANDARD SignalFx detectors
...
```hcl
module "signalfx-detectors-integration-azure-storage-file-standard" {
  source = "github.com/claranet/terraform-signalfx-detectors.git//modules/integration_azure-storage-file-standard?ref={revision}"
