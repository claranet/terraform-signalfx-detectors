...
EOF
  ...
  rule {
    ...
    runbook_url           = var.sending_operations_runbook_url
...
EOF
  ...
  rule {
    ...
    runbook_url           = var.unavailable_sending_operations_runbook_url
...
EOF
  ...
  rule {
    ...
    runbook_url           = var.unavailable_sending_operations_ratio_runbook_url
