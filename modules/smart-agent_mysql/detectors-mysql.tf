...
resource "signalfx_detector" "mysql_connections" {
  ...
  rule {
    ...
    runbook_url           = coalesce(var.connections_runbook_url, var.runbook_url)
...
EOF
  ...
  rule {
    ...
    runbook_url           = coalesce(var.slow_runbook_url, var.runbook_url)
    tip                   = var.slow_tip
    parameterized_subject = local.rule_subject
    parameterized_body    = local.rule_body
  }
...
EOF
  ...
  rule {
    ...
    runbook_url           = coalesce(var.pool_efficiency_runbook_url, var.runbook_url)
...
EOF
  ...
  rule {
    ...
    runbook_url           = coalesce(var.pool_utilization_runbook_url, var.runbook_url)
...
EOF
  ...
  rule {
    ...
    runbook_url           = coalesce(var.threads_anomaly_runbook_url, var.runbook_url)
...
EOF
  ...
  rule {
    ...
    runbook_url           = coalesce(var.questions_anomaly_runbook_url, var.runbook_url)
...
EOF
  ...
  rule {
    ...
    runbook_url           = coalesce(var.slave_sql_status_runbook_url, var.runbook_url)
...
EOF
  ...
  rule {
    ...
    runbook_url           = coalesce(var.slave_io_status_runbook_url, var.runbook_url)
