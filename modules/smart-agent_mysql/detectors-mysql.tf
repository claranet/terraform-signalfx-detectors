...
resource "signalfx_detector" "mysql_connections" {
  ...
  rule {
    ...
    runbook_url           = var.connections_runbook_url
...
EOF
  ...
  rule {
    ...
    runbook_url           = var.slow_runbook_url
    tip                   = var.slow_tip
    parameterized_subject = local.rule_subject
    parameterized_body    = local.rule_body
  }
...
EOF
  ...
  rule {
    ...
    runbook_url           = var.pool_efficiency_runbook_url
...
EOF
  ...
  rule {
    ...
    runbook_url           = var.pool_utilization_runbook_url
...
EOF
  ...
  rule {
    ...
    runbook_url           = var.threads_anomaly_runbook_url
...
EOF
  ...
  rule {
    ...
    runbook_url           = var.questions_anomaly_runbook_url
...
resource "signalfx_detector" "mysql_replication_lag" {
  ...
  rule {
    ...
    runbook_url           = var.replication_lag_runbook_url
...
EOF
  ...
  rule {
    ...
    runbook_url           = var.slave_sql_status_runbook_url
...
EOF
  ...
  rule {
    ...
    runbook_url           = var.slave_io_status_runbook_url
