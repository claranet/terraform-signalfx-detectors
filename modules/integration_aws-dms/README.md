...
```hcl
module "signalfx-detectors-integration-aws-dms" {
  source = "github.com/claranet/terraform-signalfx-detectors.git//modules/integration_aws-dms?ref={revision}"
