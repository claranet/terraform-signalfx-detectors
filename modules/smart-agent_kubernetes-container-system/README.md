# KUBERNETES-CONTAINER-SYSTEM SignalFx detectors
...
```hcl
module "signalfx-detectors-smart-agent-kubernetes-container-system" {
  source = "github.com/claranet/terraform-signalfx-detectors.git//modules/smart-agent_kubernetes-container-system?ref={revision}"
...
* [Kubernetes Container System Resource Management](https://kubernetes.io/docs/concepts/configuration/manage-resources-containers/)
