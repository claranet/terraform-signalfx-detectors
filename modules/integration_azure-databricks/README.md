# AZURE-DATABRICKS SignalFx detectors
...
```hcl
module "signalfx-detectors-integration-azure-databricks" {
  source = "github.com/claranet/terraform-signalfx-detectors.git//modules/integration_azure-databricks?ref={revision}"
