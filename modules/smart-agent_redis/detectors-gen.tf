...
resource "signalfx_detector" "blocked_over_connected_clients_ratio" {
  ...
  program_text = <<-EOF
    A = data('${var.use_otel_receiver ? "redis.clients.blocked" : "gauge.blocked_clients"}', filter=${module.filtering.signalflow})${var.blocked_over_connected_clients_ratio_aggregation_function}${var.blocked_over_connected_clients_ratio_transformation_function}
    B = data('${var.use_otel_receiver ? "redis.clients.connected" : "gauge.connected_clients"}', filter=${module.filtering.signalflow})${var.blocked_over_connected_clients_ratio_aggregation_function}${var.blocked_over_connected_clients_ratio_transformation_function}
...
resource "signalfx_detector" "stored_keys_change_rate" {
  ...
  program_text = <<-EOF
    ...
    detect(when(signal == ${var.stored_keys_change_rate_threshold_major}%{if var.stored_keys_change_rate_lasting_duration_major != null}, lasting='${var.stored_keys_change_rate_lasting_duration_major}', at_least=${var.stored_keys_change_rate_at_least_percentage_major}%{endif})).publish('MAJOR')
EOF
...
resource "signalfx_detector" "percentage_memory_used_over_max_memory_set" {
  ...
  program_text = <<-EOF
    ...
    signal = (A/B).scale(100).publish('signal')
    detect(when(signal > ${var.percentage_memory_used_over_max_memory_set_threshold_critical}%{if var.percentage_memory_used_over_max_memory_set_lasting_duration_critical != null}, lasting='${var.percentage_memory_used_over_max_memory_set_lasting_duration_critical}', at_least=${var.percentage_memory_used_over_max_memory_set_at_least_percentage_critical}%{endif})).publish('CRIT')
    detect(when(signal > ${var.percentage_memory_used_over_max_memory_set_threshold_major}%{if var.percentage_memory_used_over_max_memory_set_lasting_duration_major != null}, lasting='${var.percentage_memory_used_over_max_memory_set_lasting_duration_major}', at_least=${var.percentage_memory_used_over_max_memory_set_at_least_percentage_major}%{endif}) and (not when(signal > ${var.percentage_memory_used_over_max_memory_set_threshold_critical}%{if var.percentage_memory_used_over_max_memory_set_lasting_duration_critical != null}, lasting='${var.percentage_memory_used_over_max_memory_set_lasting_duration_critical}', at_least=${var.percentage_memory_used_over_max_memory_set_at_least_percentage_critical}%{endif}))).publish('MAJOR')
EOF
...
resource "signalfx_detector" "percentage_memory_used_over_system_memory" {
  ...
  program_text = <<-EOF
    ...
    signal = (A/B).scale(100).publish('signal')
    detect(when(signal > ${var.percentage_memory_used_over_system_memory_threshold_critical}%{if var.percentage_memory_used_over_system_memory_lasting_duration_critical != null}, lasting='${var.percentage_memory_used_over_system_memory_lasting_duration_critical}', at_least=${var.percentage_memory_used_over_system_memory_at_least_percentage_critical}%{endif})).publish('CRIT')
    detect(when(signal > ${var.percentage_memory_used_over_system_memory_threshold_major}%{if var.percentage_memory_used_over_system_memory_lasting_duration_major != null}, lasting='${var.percentage_memory_used_over_system_memory_lasting_duration_major}', at_least=${var.percentage_memory_used_over_system_memory_at_least_percentage_major}%{endif}) and (not when(signal > ${var.percentage_memory_used_over_system_memory_threshold_critical}%{if var.percentage_memory_used_over_system_memory_lasting_duration_critical != null}, lasting='${var.percentage_memory_used_over_system_memory_lasting_duration_critical}', at_least=${var.percentage_memory_used_over_system_memory_at_least_percentage_critical}%{endif}))).publish('MAJOR')
EOF
...
resource "signalfx_detector" "high_memory_fragmentation_ratio" {
  ...
  program_text = <<-EOF
    ...
    detect(when(signal > ${var.high_memory_fragmentation_ratio_threshold_critical}%{if var.high_memory_fragmentation_ratio_lasting_duration_critical != null}, lasting='${var.high_memory_fragmentation_ratio_lasting_duration_critical}', at_least=${var.high_memory_fragmentation_ratio_at_least_percentage_critical}%{endif})).publish('CRIT')
    detect(when(signal > ${var.high_memory_fragmentation_ratio_threshold_major}%{if var.high_memory_fragmentation_ratio_lasting_duration_major != null}, lasting='${var.high_memory_fragmentation_ratio_lasting_duration_major}', at_least=${var.high_memory_fragmentation_ratio_at_least_percentage_major}%{endif}) and (not when(signal > ${var.high_memory_fragmentation_ratio_threshold_critical}%{if var.high_memory_fragmentation_ratio_lasting_duration_critical != null}, lasting='${var.high_memory_fragmentation_ratio_lasting_duration_critical}', at_least=${var.high_memory_fragmentation_ratio_at_least_percentage_critical}%{endif}))).publish('MAJOR')
EOF
...
resource "signalfx_detector" "low_memory_fragmentation_ratio" {
  ...
  program_text = <<-EOF
    ...
    signal = (A/B).publish('signal')
    detect(when(signal < ${var.low_memory_fragmentation_ratio_threshold_critical}%{if var.low_memory_fragmentation_ratio_lasting_duration_critical != null}, lasting='${var.low_memory_fragmentation_ratio_lasting_duration_critical}', at_least=${var.low_memory_fragmentation_ratio_at_least_percentage_critical}%{endif})).publish('CRIT')
    detect(when(signal < ${var.low_memory_fragmentation_ratio_threshold_major}%{if var.low_memory_fragmentation_ratio_lasting_duration_major != null}, lasting='${var.low_memory_fragmentation_ratio_lasting_duration_major}', at_least=${var.low_memory_fragmentation_ratio_at_least_percentage_major}%{endif}) and (not when(signal < ${var.low_memory_fragmentation_ratio_threshold_critical}%{if var.low_memory_fragmentation_ratio_lasting_duration_critical != null}, lasting='${var.low_memory_fragmentation_ratio_lasting_duration_critical}', at_least=${var.low_memory_fragmentation_ratio_at_least_percentage_critical}%{endif}))).publish('MAJOR')
EOF
...
resource "signalfx_detector" "hitrate" {
  ...
  program_text = <<-EOF
    ...
    detect(when(signal < ${var.hitrate_threshold_critical}%{if var.hitrate_lasting_duration_critical != null}, lasting='${var.hitrate_lasting_duration_critical}', at_least=${var.hitrate_at_least_percentage_critical}%{endif})).publish('CRIT')
    detect(when(signal < ${var.hitrate_threshold_major}%{if var.hitrate_lasting_duration_major != null}, lasting='${var.hitrate_lasting_duration_major}', at_least=${var.hitrate_at_least_percentage_major}%{endif}) and (not when(signal < ${var.hitrate_threshold_critical}%{if var.hitrate_lasting_duration_critical != null}, lasting='${var.hitrate_lasting_duration_critical}', at_least=${var.hitrate_at_least_percentage_critical}%{endif}))).publish('MAJOR')
    detect(when(signal < ${var.hitrate_threshold_minor}%{if var.hitrate_lasting_duration_minor != null}, lasting='${var.hitrate_lasting_duration_minor}', at_least=${var.hitrate_at_least_percentage_minor}%{endif}) and (not when(signal < ${var.hitrate_threshold_major}%{if var.hitrate_lasting_duration_major != null}, lasting='${var.hitrate_lasting_duration_major}', at_least=${var.hitrate_at_least_percentage_major}%{endif}))).publish('MINOR')
EOF
