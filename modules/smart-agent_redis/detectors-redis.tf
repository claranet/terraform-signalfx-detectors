...
EOF
  ...
  rule {
    ...
    runbook_url           = var.evicted_keys_runbook_url
...
EOF
  ...
  rule {
    ...
    runbook_url           = var.expirations_runbook_url
...
EOF
  ...
  rule {
    ...
    runbook_url           = var.blocked_clients_runbook_url
...
EOF
  ...
  rule {
    ...
    runbook_url           = var.keyspace_full_runbook_url
...
EOF
  ...
  rule {
    ...
    runbook_url           = var.memory_used_max_runbook_url
...
EOF
  ...
  rule {
    ...
    runbook_url           = var.memory_used_total_runbook_url
...
EOF
  ...
  rule {
    ...
    runbook_url           = var.memory_frag_high_runbook_url
...
EOF
  ...
  rule {
    ...
    runbook_url           = var.memory_frag_low_runbook_url
...
EOF
  ...
  rule {
    ...
    runbook_url           = var.rejected_connections_runbook_url
...
EOF
  ...
  rule {
    ...
    runbook_url           = var.hitrate_runbook_url
    tip                   = var.hitrate_tip
    parameterized_subject = local.rule_subject
    parameterized_body    = local.rule_body
  }
