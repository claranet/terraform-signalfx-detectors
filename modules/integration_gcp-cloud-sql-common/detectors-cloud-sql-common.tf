...
EOF
  ...
  rule {
    ...
    runbook_url           = var.cpu_utilization_runbook_url
...
EOF
  ...
  rule {
    ...
    runbook_url           = var.disk_utilization_runbook_url
...
EOF
  ...
  rule {
    ...
    runbook_url           = var.disk_utilization_forecast_runbook_url
...
EOF
  ...
  rule {
    ...
    runbook_url           = var.memory_utilization_runbook_url
...
EOF
  ...
  rule {
    ...
    runbook_url           = var.memory_utilization_forecast_runbook_url
