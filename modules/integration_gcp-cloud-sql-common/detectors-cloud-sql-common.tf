...
EOF
  ...
  rule {
    ...
    runbook_url           = coalesce(var.disk_utilization_runbook_url, var.runbook_url)
...
EOF
  ...
  rule {
    ...
    runbook_url           = coalesce(var.disk_utilization_forecast_runbook_url, var.runbook_url)
...
EOF
  ...
  rule {
    ...
    runbook_url           = coalesce(var.memory_utilization_runbook_url, var.runbook_url)
...
EOF
  ...
  rule {
    ...
    runbook_url           = coalesce(var.memory_utilization_forecast_runbook_url, var.runbook_url)
