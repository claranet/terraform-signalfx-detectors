...
variable "cpu_utilization_transformation_function" {
  ...
  type        = string
  default     = ".min(over='30m').scale(100)"
}
...
variable "disk_utilization_transformation_function" {
  ...
  type        = string
  default     = ".min(over='10m').scale(100)"
}
...
variable "disk_utilization_lasting_duration_critical" {
  description = "Minimum duration that conditions must be true before raising alert"
  type        = string
  default     = null
}

variable "disk_utilization_at_least_percentage_critical" {
  description = "Percentage of lasting that conditions must be true before raising alert (>= 0.0 and <= 1.0)"
  type        = number
  default     = 1
}
...
variable "disk_utilization_lasting_duration_major" {
  description = "Minimum duration that conditions must be true before raising alert"
  type        = string
  default     = null
}

variable "disk_utilization_at_least_percentage_major" {
  description = "Percentage of lasting that conditions must be true before raising alert (>= 0.0 and <= 1.0)"
  type        = number
  default     = 1
}
