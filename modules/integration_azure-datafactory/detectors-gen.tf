resource "signalfx_detector" "activity_error_rate" {
  ...
  program_text = <<-EOF
    ...
    detect(when(signal > ${var.activity_error_rate_threshold_major} and signal <= ${var.activity_error_rate_threshold_critical}))).publish('MAJOR')
EOF
...
resource "signalfx_detector" "pipeline_error_rate" {
  ...
  program_text = <<-EOF
    ...
    detect(when(signal > ${var.pipeline_error_rate_threshold_major} and signal <= ${var.pipeline_error_rate_threshold_critical}))).publish('MAJOR')
EOF
...
resource "signalfx_detector" "trigger_error_rate" {
  ...
  program_text = <<-EOF
    ...
    detect(when(signal > ${var.trigger_error_rate_threshold_major} and signal <= ${var.trigger_error_rate_threshold_critical}))).publish('MAJOR')
EOF
...
resource "signalfx_detector" "available_memory" {
  ...
  program_text = <<-EOF
    ...
    detect(when(signal < ${var.available_memory_threshold_major} and signal >= ${var.available_memory_threshold_critical}))).publish('MAJOR')
EOF
...
resource "signalfx_detector" "cpu_percentage" {
  ...
  program_text = <<-EOF
    ...
    detect(when(signal > ${var.cpu_percentage_threshold_major} and signal <= ${var.cpu_percentage_threshold_critical}))).publish('MAJOR')
EOF
