resource "signalfx_detector" "activity_error_rate" {
  ...
  program_text = <<-EOF
    ...
    detect(when(signal > ${var.activity_error_rate_threshold_critical}, lasting=${var.activity_error_rate_lasting_duration_critical == null ? "None" : format("'%s'", var.activity_error_rate_lasting_duration_critical)}, at_least=${var.activity_error_rate_at_least_percentage_critical})).publish('CRIT')
    detect(when(signal > ${var.activity_error_rate_threshold_major}, lasting=${var.activity_error_rate_lasting_duration_major == null ? "None" : format("'%s'", var.activity_error_rate_lasting_duration_major)}, at_least=${var.activity_error_rate_at_least_percentage_major}) and (not when(signal > ${var.activity_error_rate_threshold_critical}, lasting=${var.activity_error_rate_lasting_duration_critical == null ? "None" : format("'%s'", var.activity_error_rate_lasting_duration_critical)}, at_least=${var.activity_error_rate_at_least_percentage_critical}))).publish('MAJOR')
EOF
...
resource "signalfx_detector" "pipeline_error_rate" {
  ...
  program_text = <<-EOF
    ...
    detect(when(signal > ${var.pipeline_error_rate_threshold_critical}, lasting=${var.pipeline_error_rate_lasting_duration_critical == null ? "None" : format("'%s'", var.pipeline_error_rate_lasting_duration_critical)}, at_least=${var.pipeline_error_rate_at_least_percentage_critical})).publish('CRIT')
    detect(when(signal > ${var.pipeline_error_rate_threshold_major}, lasting=${var.pipeline_error_rate_lasting_duration_major == null ? "None" : format("'%s'", var.pipeline_error_rate_lasting_duration_major)}, at_least=${var.pipeline_error_rate_at_least_percentage_major}) and (not when(signal > ${var.pipeline_error_rate_threshold_critical}, lasting=${var.pipeline_error_rate_lasting_duration_critical == null ? "None" : format("'%s'", var.pipeline_error_rate_lasting_duration_critical)}, at_least=${var.pipeline_error_rate_at_least_percentage_critical}))).publish('MAJOR')
EOF
...
resource "signalfx_detector" "trigger_error_rate" {
  ...
  program_text = <<-EOF
    ...
    detect(when(signal > ${var.trigger_error_rate_threshold_critical}, lasting=${var.trigger_error_rate_lasting_duration_critical == null ? "None" : format("'%s'", var.trigger_error_rate_lasting_duration_critical)}, at_least=${var.trigger_error_rate_at_least_percentage_critical})).publish('CRIT')
    detect(when(signal > ${var.trigger_error_rate_threshold_major}, lasting=${var.trigger_error_rate_lasting_duration_major == null ? "None" : format("'%s'", var.trigger_error_rate_lasting_duration_major)}, at_least=${var.trigger_error_rate_at_least_percentage_major}) and (not when(signal > ${var.trigger_error_rate_threshold_critical}, lasting=${var.trigger_error_rate_lasting_duration_critical == null ? "None" : format("'%s'", var.trigger_error_rate_lasting_duration_critical)}, at_least=${var.trigger_error_rate_at_least_percentage_critical}))).publish('MAJOR')
EOF
...
resource "signalfx_detector" "available_memory" {
  ...
  program_text = <<-EOF
    ...
    detect(when(signal < ${var.available_memory_threshold_critical}, lasting=${var.available_memory_lasting_duration_critical == null ? "None" : format("'%s'", var.available_memory_lasting_duration_critical)}, at_least=${var.available_memory_at_least_percentage_critical})).publish('CRIT')
    detect(when(signal < ${var.available_memory_threshold_major}, lasting=${var.available_memory_lasting_duration_major == null ? "None" : format("'%s'", var.available_memory_lasting_duration_major)}, at_least=${var.available_memory_at_least_percentage_major}) and (not when(signal < ${var.available_memory_threshold_critical}, lasting=${var.available_memory_lasting_duration_critical == null ? "None" : format("'%s'", var.available_memory_lasting_duration_critical)}, at_least=${var.available_memory_at_least_percentage_critical}))).publish('MAJOR')
EOF
...
resource "signalfx_detector" "cpu_percentage" {
  ...
  program_text = <<-EOF
    ...
    detect(when(signal > ${var.cpu_percentage_threshold_critical}, lasting=${var.cpu_percentage_lasting_duration_critical == null ? "None" : format("'%s'", var.cpu_percentage_lasting_duration_critical)}, at_least=${var.cpu_percentage_at_least_percentage_critical})).publish('CRIT')
    detect(when(signal > ${var.cpu_percentage_threshold_major}, lasting=${var.cpu_percentage_lasting_duration_major == null ? "None" : format("'%s'", var.cpu_percentage_lasting_duration_major)}, at_least=${var.cpu_percentage_at_least_percentage_major}) and (not when(signal > ${var.cpu_percentage_threshold_critical}, lasting=${var.cpu_percentage_lasting_duration_critical == null ? "None" : format("'%s'", var.cpu_percentage_lasting_duration_critical)}, at_least=${var.cpu_percentage_at_least_percentage_critical}))).publish('MAJOR')
EOF
