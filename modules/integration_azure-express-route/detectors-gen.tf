...
resource "signalfx_detector" "bgp_availability" {
  ...
  program_text = <<-EOF
    ...
    detect(when(signal < ${var.bgp_availability_threshold_critical}%{if var.bgp_availability_lasting_duration_critical != null}, lasting='${var.bgp_availability_lasting_duration_critical}', at_least=${var.bgp_availability_at_least_percentage_critical}%{endif})).publish('CRIT')
    detect(when(signal < ${var.bgp_availability_threshold_major}%{if var.bgp_availability_lasting_duration_major != null}, lasting='${var.bgp_availability_lasting_duration_major}', at_least=${var.bgp_availability_at_least_percentage_major}%{endif}) and (not when(signal < ${var.bgp_availability_threshold_critical}%{if var.bgp_availability_lasting_duration_critical != null}, lasting='${var.bgp_availability_lasting_duration_critical}', at_least=${var.bgp_availability_at_least_percentage_critical}%{endif}))).publish('MAJOR')
    detect(when(signal < ${var.bgp_availability_threshold_warning}%{if var.bgp_availability_lasting_duration_warning != null}, lasting='${var.bgp_availability_lasting_duration_warning}', at_least=${var.bgp_availability_at_least_percentage_warning}%{endif}) and (not when(signal < ${var.bgp_availability_threshold_major}%{if var.bgp_availability_lasting_duration_major != null}, lasting='${var.bgp_availability_lasting_duration_major}', at_least=${var.bgp_availability_at_least_percentage_major}%{endif}))).publish('WARN')
EOF
...
resource "signalfx_detector" "arp_availability" {
  ...
  program_text = <<-EOF
    ...
    detect(when(signal < ${var.arp_availability_threshold_critical}%{if var.arp_availability_lasting_duration_critical != null}, lasting='${var.arp_availability_lasting_duration_critical}', at_least=${var.arp_availability_at_least_percentage_critical}%{endif})).publish('CRIT')
    detect(when(signal < ${var.arp_availability_threshold_major}%{if var.arp_availability_lasting_duration_major != null}, lasting='${var.arp_availability_lasting_duration_major}', at_least=${var.arp_availability_at_least_percentage_major}%{endif}) and (not when(signal < ${var.arp_availability_threshold_critical}%{if var.arp_availability_lasting_duration_critical != null}, lasting='${var.arp_availability_lasting_duration_critical}', at_least=${var.arp_availability_at_least_percentage_critical}%{endif}))).publish('MAJOR')
    detect(when(signal < ${var.arp_availability_threshold_warning}%{if var.arp_availability_lasting_duration_warning != null}, lasting='${var.arp_availability_lasting_duration_warning}', at_least=${var.arp_availability_at_least_percentage_warning}%{endif}) and (not when(signal < ${var.arp_availability_threshold_major}%{if var.arp_availability_lasting_duration_major != null}, lasting='${var.arp_availability_lasting_duration_major}', at_least=${var.arp_availability_at_least_percentage_major}%{endif}))).publish('WARN')
EOF
