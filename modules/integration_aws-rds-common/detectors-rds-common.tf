...
EOF
  ...
  rule {
    ...
    runbook_url           = coalesce(var.cpu_90_15min_runbook_url, var.runbook_url)
...
EOF
  ...
  rule {
    ...
    runbook_url           = coalesce(var.free_space_low_runbook_url, var.runbook_url)
...
EOF
  ...
  rule {
    ...
    runbook_url           = coalesce(var.replica_lag_runbook_url, var.runbook_url)
