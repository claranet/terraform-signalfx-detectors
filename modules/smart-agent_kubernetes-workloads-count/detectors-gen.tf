resource "signalfx_detector" "workloads_count" {
  ...
  program_text = <<-EOF
    ...
    detect(when(signal > ${var.workloads_count_threshold_minor}%{if var.workloads_count_lasting_duration_minor != null}, lasting='${var.workloads_count_lasting_duration_minor}', at_least=${var.workloads_count_at_least_percentage_minor}%{endif})).publish('MINOR')
    detect(when(signal > ${var.workloads_count_threshold_warning}%{if var.workloads_count_lasting_duration_warning != null}, lasting='${var.workloads_count_lasting_duration_warning}', at_least=${var.workloads_count_at_least_percentage_warning}%{endif}) and (not when(signal > ${var.workloads_count_threshold_minor}%{if var.workloads_count_lasting_duration_minor != null}, lasting='${var.workloads_count_lasting_duration_minor}', at_least=${var.workloads_count_at_least_percentage_minor}%{endif}))).publish('WARN')
EOF
