...
```hcl
module "signalfx-detectors-integration-aws-asg" {
  source = "github.com/claranet/terraform-signalfx-detectors.git//modules/integration_aws-asg?ref={revision}"

  environment                     = var.environment
  notifications                   = local.notifications
  max_capacity_threshold_critical = 90
  max_capacity_threshold_major    = 80
}
```
...
|---|---|---|---|---|---|
|AWS ASG desired reached the max capacity|X|X|-|-|-|
