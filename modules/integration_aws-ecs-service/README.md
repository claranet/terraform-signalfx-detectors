...
```hcl
module "signalfx-detectors-cloud-aws-ecs-service" {
  source = "github.com/claranet/terraform-signalfx-detectors.git//cloud/aws/ecs/service?ref={revision}"
...
* AWS ECS heartbeat
* AWS ECS service CPU utilization
* AWS ECS service memory utilization
