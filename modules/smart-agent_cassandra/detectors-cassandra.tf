...
EOF
  ...
  rule {
    ...
    runbook_url           = var.read_p99_latency_runbook_url
...
EOF
  ...
  rule {
    ...
    runbook_url           = var.write_p99_latency_runbook_url
...
EOF
  ...
  rule {
    ...
    runbook_url           = var.read_real_time_latency_runbook_url
...
EOF
  ...
  rule {
    ...
    runbook_url           = var.write_real_time_latency_runbook_url
...
EOF
  ...
  rule {
    ...
    runbook_url           = var.casread_p99_latency_runbook_url
...
EOF
  ...
  rule {
    ...
    runbook_url           = var.caswrite_p99_latency_runbook_url
...
EOF
  ...
  rule {
    ...
    runbook_url           = var.casread_real_time_latency_runbook_url
...
EOF
  ...
  rule {
    ...
    runbook_url           = var.caswrite_real_time_latency_runbook_url
...
EOF
  ...
  rule {
    ...
    runbook_url           = var.storage_exceptions_runbook_url
