...
EOF
  ...
  rule {
    ...
    notifications         = coalescelist(lookup(var.read_latency_99th_percentile_notifications, "critical", []), var.notifications.critical)
  ...
  rule {
    ...
    notifications         = coalescelist(lookup(var.read_latency_99th_percentile_notifications, "major", []), var.notifications.major)
    runbook_url           = try(coalesce(var.read_latency_99th_percentile_runbook_url, var.runbook_url), "")
    tip                   = var.read_latency_99th_percentile_tip
    parameterized_subject = var.message_subject == "" ? local.rule_subject : var.message_subject
    parameterized_body    = var.message_body == "" ? local.rule_body : var.message_body
...
EOF
  ...
  rule {
    ...
    notifications         = coalescelist(lookup(var.write_latency_99th_percentile_notifications, "critical", []), var.notifications.critical)
  ...
  rule {
    ...
    notifications         = coalescelist(lookup(var.write_latency_99th_percentile_notifications, "major", []), var.notifications.major)
    runbook_url           = try(coalesce(var.write_latency_99th_percentile_runbook_url, var.runbook_url), "")
    tip                   = var.write_latency_99th_percentile_tip
    parameterized_subject = var.message_subject == "" ? local.rule_subject : var.message_subject
    parameterized_body    = var.message_body == "" ? local.rule_body : var.message_body
...
EOF
  ...
  rule {
    ...
    notifications         = coalescelist(lookup(var.read_latency_real_time_notifications, "critical", []), var.notifications.critical)
  ...
  rule {
    ...
    notifications         = coalescelist(lookup(var.read_latency_real_time_notifications, "major", []), var.notifications.major)
    runbook_url           = try(coalesce(var.read_latency_real_time_runbook_url, var.runbook_url), "")
    tip                   = var.read_latency_real_time_tip
    parameterized_subject = var.message_subject == "" ? local.rule_subject : var.message_subject
    parameterized_body    = var.message_body == "" ? local.rule_body : var.message_body
...
EOF
  ...
  rule {
    ...
    notifications         = coalescelist(lookup(var.write_latency_real_time_notifications, "critical", []), var.notifications.critical)
  ...
  rule {
    ...
    notifications         = coalescelist(lookup(var.write_latency_real_time_notifications, "major", []), var.notifications.major)
    runbook_url           = try(coalesce(var.write_latency_real_time_runbook_url, var.runbook_url), "")
    tip                   = var.write_latency_real_time_tip
    parameterized_subject = var.message_subject == "" ? local.rule_subject : var.message_subject
    parameterized_body    = var.message_body == "" ? local.rule_body : var.message_body
...
EOF
  ...
  rule {
    ...
    notifications         = coalescelist(lookup(var.transactional_read_latency_99th_percentile_notifications, "critical", []), var.notifications.critical)
  ...
  rule {
    ...
    notifications         = coalescelist(lookup(var.transactional_read_latency_99th_percentile_notifications, "major", []), var.notifications.major)
    runbook_url           = try(coalesce(var.transactional_read_latency_99th_percentile_runbook_url, var.runbook_url), "")
    tip                   = var.transactional_read_latency_99th_percentile_tip
    parameterized_subject = var.message_subject == "" ? local.rule_subject : var.message_subject
    parameterized_body    = var.message_body == "" ? local.rule_body : var.message_body
...
EOF
  ...
  rule {
    ...
    notifications         = coalescelist(lookup(var.transactional_write_latency_99th_percentile_notifications, "critical", []), var.notifications.critical)
  ...
  rule {
    ...
    notifications         = coalescelist(lookup(var.transactional_write_latency_99th_percentile_notifications, "major", []), var.notifications.major)
    runbook_url           = try(coalesce(var.transactional_write_latency_99th_percentile_runbook_url, var.runbook_url), "")
    tip                   = var.transactional_write_latency_99th_percentile_tip
    parameterized_subject = var.message_subject == "" ? local.rule_subject : var.message_subject
    parameterized_body    = var.message_body == "" ? local.rule_body : var.message_body
...
EOF
  ...
  rule {
    ...
    notifications         = coalescelist(lookup(var.transactional_read_latency_real_time_notifications, "critical", []), var.notifications.critical)
  ...
  rule {
    ...
    notifications         = coalescelist(lookup(var.transactional_read_latency_real_time_notifications, "major", []), var.notifications.major)
    runbook_url           = try(coalesce(var.transactional_read_latency_real_time_runbook_url, var.runbook_url), "")
    tip                   = var.transactional_read_latency_real_time_tip
    parameterized_subject = var.message_subject == "" ? local.rule_subject : var.message_subject
    parameterized_body    = var.message_body == "" ? local.rule_body : var.message_body
...
EOF
  ...
  rule {
    ...
    notifications         = coalescelist(lookup(var.transactional_write_latency_real_time_notifications, "critical", []), var.notifications.critical)
  ...
  rule {
    ...
    notifications         = coalescelist(lookup(var.transactional_write_latency_real_time_notifications, "major", []), var.notifications.major)
    runbook_url           = try(coalesce(var.transactional_write_latency_real_time_runbook_url, var.runbook_url), "")
    tip                   = var.transactional_write_latency_real_time_tip
    parameterized_subject = var.message_subject == "" ? local.rule_subject : var.message_subject
    parameterized_body    = var.message_body == "" ? local.rule_body : var.message_body
...
EOF
  ...
  rule {
    ...
    notifications         = coalescelist(lookup(var.storage_exceptions_count_notifications, "major", []), var.notifications.major)
