...
resource "signalfx_detector" "read_latency_99th_percentile" {
  ...
  program_text = <<-EOF
    ...
    detect(when(signal > ${var.read_latency_99th_percentile_threshold_critical}%{if var.read_latency_99th_percentile_lasting_duration_critical != null}, lasting='${var.read_latency_99th_percentile_lasting_duration_critical}', at_least=${var.read_latency_99th_percentile_at_least_percentage_critical}%{endif})).publish('CRIT')
    detect(when(signal > ${var.read_latency_99th_percentile_threshold_major}%{if var.read_latency_99th_percentile_lasting_duration_major != null}, lasting='${var.read_latency_99th_percentile_lasting_duration_major}', at_least=${var.read_latency_99th_percentile_at_least_percentage_major}%{endif}) and (not when(signal > ${var.read_latency_99th_percentile_threshold_critical}%{if var.read_latency_99th_percentile_lasting_duration_critical != null}, lasting='${var.read_latency_99th_percentile_lasting_duration_critical}', at_least=${var.read_latency_99th_percentile_at_least_percentage_critical}%{endif}))).publish('MAJOR')
EOF
...
resource "signalfx_detector" "write_latency_99th_percentile" {
  ...
  program_text = <<-EOF
    ...
    detect(when(signal > ${var.write_latency_99th_percentile_threshold_critical}%{if var.write_latency_99th_percentile_lasting_duration_critical != null}, lasting='${var.write_latency_99th_percentile_lasting_duration_critical}', at_least=${var.write_latency_99th_percentile_at_least_percentage_critical}%{endif})).publish('CRIT')
    detect(when(signal > ${var.write_latency_99th_percentile_threshold_major}%{if var.write_latency_99th_percentile_lasting_duration_major != null}, lasting='${var.write_latency_99th_percentile_lasting_duration_major}', at_least=${var.write_latency_99th_percentile_at_least_percentage_major}%{endif}) and (not when(signal > ${var.write_latency_99th_percentile_threshold_critical}%{if var.write_latency_99th_percentile_lasting_duration_critical != null}, lasting='${var.write_latency_99th_percentile_lasting_duration_critical}', at_least=${var.write_latency_99th_percentile_at_least_percentage_critical}%{endif}))).publish('MAJOR')
EOF
...
resource "signalfx_detector" "read_latency_real_time" {
  ...
  program_text = <<-EOF
    ...
    detect(when(signal > ${var.read_latency_real_time_threshold_critical}%{if var.read_latency_real_time_lasting_duration_critical != null}, lasting='${var.read_latency_real_time_lasting_duration_critical}', at_least=${var.read_latency_real_time_at_least_percentage_critical}%{endif})).publish('CRIT')
    detect(when(signal > ${var.read_latency_real_time_threshold_major}%{if var.read_latency_real_time_lasting_duration_major != null}, lasting='${var.read_latency_real_time_lasting_duration_major}', at_least=${var.read_latency_real_time_at_least_percentage_major}%{endif}) and (not when(signal > ${var.read_latency_real_time_threshold_critical}%{if var.read_latency_real_time_lasting_duration_critical != null}, lasting='${var.read_latency_real_time_lasting_duration_critical}', at_least=${var.read_latency_real_time_at_least_percentage_critical}%{endif}))).publish('MAJOR')
EOF
...
resource "signalfx_detector" "write_latency_real_time" {
  ...
  program_text = <<-EOF
    ...
    signal = (A/B).fill(0).publish('signal')
    detect(when(signal > ${var.write_latency_real_time_threshold_critical}%{if var.write_latency_real_time_lasting_duration_critical != null}, lasting='${var.write_latency_real_time_lasting_duration_critical}', at_least=${var.write_latency_real_time_at_least_percentage_critical}%{endif})).publish('CRIT')
    detect(when(signal > ${var.write_latency_real_time_threshold_major}%{if var.write_latency_real_time_lasting_duration_major != null}, lasting='${var.write_latency_real_time_lasting_duration_major}', at_least=${var.write_latency_real_time_at_least_percentage_major}%{endif}) and (not when(signal > ${var.write_latency_real_time_threshold_critical}%{if var.write_latency_real_time_lasting_duration_critical != null}, lasting='${var.write_latency_real_time_lasting_duration_critical}', at_least=${var.write_latency_real_time_at_least_percentage_critical}%{endif}))).publish('MAJOR')
EOF
...
resource "signalfx_detector" "transactional_read_latency_99th_percentile" {
  ...
  program_text = <<-EOF
    ...
    detect(when(signal > ${var.transactional_read_latency_99th_percentile_threshold_critical}%{if var.transactional_read_latency_99th_percentile_lasting_duration_critical != null}, lasting='${var.transactional_read_latency_99th_percentile_lasting_duration_critical}', at_least=${var.transactional_read_latency_99th_percentile_at_least_percentage_critical}%{endif})).publish('CRIT')
    detect(when(signal > ${var.transactional_read_latency_99th_percentile_threshold_major}%{if var.transactional_read_latency_99th_percentile_lasting_duration_major != null}, lasting='${var.transactional_read_latency_99th_percentile_lasting_duration_major}', at_least=${var.transactional_read_latency_99th_percentile_at_least_percentage_major}%{endif}) and (not when(signal > ${var.transactional_read_latency_99th_percentile_threshold_critical}%{if var.transactional_read_latency_99th_percentile_lasting_duration_critical != null}, lasting='${var.transactional_read_latency_99th_percentile_lasting_duration_critical}', at_least=${var.transactional_read_latency_99th_percentile_at_least_percentage_critical}%{endif}))).publish('MAJOR')
EOF
...
resource "signalfx_detector" "transactional_write_latency_99th_percentile" {
  ...
  program_text = <<-EOF
    ...
    detect(when(signal > ${var.transactional_write_latency_99th_percentile_threshold_critical}%{if var.transactional_write_latency_99th_percentile_lasting_duration_critical != null}, lasting='${var.transactional_write_latency_99th_percentile_lasting_duration_critical}', at_least=${var.transactional_write_latency_99th_percentile_at_least_percentage_critical}%{endif})).publish('CRIT')
    detect(when(signal > ${var.transactional_write_latency_99th_percentile_threshold_major}%{if var.transactional_write_latency_99th_percentile_lasting_duration_major != null}, lasting='${var.transactional_write_latency_99th_percentile_lasting_duration_major}', at_least=${var.transactional_write_latency_99th_percentile_at_least_percentage_major}%{endif}) and (not when(signal > ${var.transactional_write_latency_99th_percentile_threshold_critical}%{if var.transactional_write_latency_99th_percentile_lasting_duration_critical != null}, lasting='${var.transactional_write_latency_99th_percentile_lasting_duration_critical}', at_least=${var.transactional_write_latency_99th_percentile_at_least_percentage_critical}%{endif}))).publish('MAJOR')
EOF
...
resource "signalfx_detector" "transactional_read_latency_real_time" {
  ...
  program_text = <<-EOF
    ...
    signal = (A/B).fill(0).publish('signal')
    detect(when(signal > ${var.transactional_read_latency_real_time_threshold_critical}%{if var.transactional_read_latency_real_time_lasting_duration_critical != null}, lasting='${var.transactional_read_latency_real_time_lasting_duration_critical}', at_least=${var.transactional_read_latency_real_time_at_least_percentage_critical}%{endif})).publish('CRIT')
    detect(when(signal > ${var.transactional_read_latency_real_time_threshold_major}%{if var.transactional_read_latency_real_time_lasting_duration_major != null}, lasting='${var.transactional_read_latency_real_time_lasting_duration_major}', at_least=${var.transactional_read_latency_real_time_at_least_percentage_major}%{endif}) and (not when(signal > ${var.transactional_read_latency_real_time_threshold_critical}%{if var.transactional_read_latency_real_time_lasting_duration_critical != null}, lasting='${var.transactional_read_latency_real_time_lasting_duration_critical}', at_least=${var.transactional_read_latency_real_time_at_least_percentage_critical}%{endif}))).publish('MAJOR')
EOF
...
resource "signalfx_detector" "transactional_write_latency_real_time" {
  ...
  program_text = <<-EOF
    ...
    signal = (A/B).fill(0).publish('signal')
    detect(when(signal > ${var.transactional_write_latency_real_time_threshold_critical}%{if var.transactional_write_latency_real_time_lasting_duration_critical != null}, lasting='${var.transactional_write_latency_real_time_lasting_duration_critical}', at_least=${var.transactional_write_latency_real_time_at_least_percentage_critical}%{endif})).publish('CRIT')
    detect(when(signal > ${var.transactional_write_latency_real_time_threshold_major}%{if var.transactional_write_latency_real_time_lasting_duration_major != null}, lasting='${var.transactional_write_latency_real_time_lasting_duration_major}', at_least=${var.transactional_write_latency_real_time_at_least_percentage_major}%{endif}) and (not when(signal > ${var.transactional_write_latency_real_time_threshold_critical}%{if var.transactional_write_latency_real_time_lasting_duration_critical != null}, lasting='${var.transactional_write_latency_real_time_lasting_duration_critical}', at_least=${var.transactional_write_latency_real_time_at_least_percentage_critical}%{endif}))).publish('MAJOR')
EOF
...
resource "signalfx_detector" "storage_exceptions_count" {
  ...
  program_text = <<-EOF
    ...
    detect(when(signal > ${var.storage_exceptions_count_threshold_major}%{if var.storage_exceptions_count_lasting_duration_major != null}, lasting='${var.storage_exceptions_count_lasting_duration_major}', at_least=${var.storage_exceptions_count_at_least_percentage_major}%{endif})).publish('MAJOR')
EOF
