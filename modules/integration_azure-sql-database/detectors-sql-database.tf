...
resource "signalfx_detector" "free_space" {
  ...
  rule {
    ...
    runbook_url           = coalesce(var.free_space_runbook_url, var.runbook_url)
...
resource "signalfx_detector" "dtu_consumption" {
  ...
  rule {
    ...
    runbook_url           = coalesce(var.dtu_consumption_runbook_url, var.runbook_url)
...
resource "signalfx_detector" "deadlocks_count" {
  ...
  rule {
    ...
    runbook_url           = coalesce(var.deadlocks_count_runbook_url, var.runbook_url)
