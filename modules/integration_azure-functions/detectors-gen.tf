...
resource "signalfx_detector" "http_5xx_errors_rate" {
  ...
  program_text = <<-EOF
    ...
    detect(when(signal > ${var.http_5xx_errors_rate_threshold_critical}%{if var.http_5xx_errors_rate_lasting_duration_critical != null}, lasting='${var.http_5xx_errors_rate_lasting_duration_critical}', at_least=${var.http_5xx_errors_rate_at_least_percentage_critical}%{endif})).publish('CRIT')
    detect(when(signal > ${var.http_5xx_errors_rate_threshold_major}%{if var.http_5xx_errors_rate_lasting_duration_major != null}, lasting='${var.http_5xx_errors_rate_lasting_duration_major}', at_least=${var.http_5xx_errors_rate_at_least_percentage_major}%{endif}) and (not when(signal > ${var.http_5xx_errors_rate_threshold_critical}%{if var.http_5xx_errors_rate_lasting_duration_critical != null}, lasting='${var.http_5xx_errors_rate_lasting_duration_critical}', at_least=${var.http_5xx_errors_rate_at_least_percentage_critical}%{endif}))).publish('MAJOR')
EOF
...
resource "signalfx_detector" "high_connections_count" {
  ...
  program_text = <<-EOF
    ...
    detect(when(signal > ${var.high_connections_count_threshold_critical}%{if var.high_connections_count_lasting_duration_critical != null}, lasting='${var.high_connections_count_lasting_duration_critical}', at_least=${var.high_connections_count_at_least_percentage_critical}%{endif})).publish('CRIT')
    detect(when(signal > ${var.high_connections_count_threshold_major}%{if var.high_connections_count_lasting_duration_major != null}, lasting='${var.high_connections_count_lasting_duration_major}', at_least=${var.high_connections_count_at_least_percentage_major}%{endif}) and (not when(signal > ${var.high_connections_count_threshold_critical}%{if var.high_connections_count_lasting_duration_critical != null}, lasting='${var.high_connections_count_lasting_duration_critical}', at_least=${var.high_connections_count_at_least_percentage_critical}%{endif}))).publish('MAJOR')
EOF
...
resource "signalfx_detector" "high_threads_count" {
  ...
  program_text = <<-EOF
    ...
    detect(when(signal > ${var.high_threads_count_threshold_critical}%{if var.high_threads_count_lasting_duration_critical != null}, lasting='${var.high_threads_count_lasting_duration_critical}', at_least=${var.high_threads_count_at_least_percentage_critical}%{endif})).publish('CRIT')
    detect(when(signal > ${var.high_threads_count_threshold_major}%{if var.high_threads_count_lasting_duration_major != null}, lasting='${var.high_threads_count_lasting_duration_major}', at_least=${var.high_threads_count_at_least_percentage_major}%{endif}) and (not when(signal > ${var.high_threads_count_threshold_critical}%{if var.high_threads_count_lasting_duration_critical != null}, lasting='${var.high_threads_count_lasting_duration_critical}', at_least=${var.high_threads_count_at_least_percentage_critical}%{endif}))).publish('MAJOR')
EOF
