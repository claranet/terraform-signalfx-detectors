...
resource "signalfx_detector" "http_5xx_errors_rate" {
  ...
  rule {
    ...
    runbook_url           = coalesce(var.http_5xx_errors_rate_runbook_url, var.runbook_url)
...
resource "signalfx_detector" "high_connections_count" {
  ...
  rule {
    ...
    runbook_url           = coalesce(var.high_connections_count_runbook_url, var.runbook_url)
...
resource "signalfx_detector" "high_threads_count" {
  ...
  rule {
    ...
    runbook_url           = coalesce(var.high_threads_count_runbook_url, var.runbook_url)
