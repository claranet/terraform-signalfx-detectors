...
variable "user_errors_clear_duration" {
  description = "Duration for the user_errors clear condition"
  type        = string
  default     = "15m"
}
...
variable "server_errors_clear_duration" {
  description = "Duration for the server_errors clear condition"
  type        = string
  default     = "15m"
}
