...
resource "signalfx_detector" "jobs_failed" {
  ...
  program_text = <<-EOF
		...
		detect(ON_Condition_CRIT, off=when(signal is None, '${var.jobs_failed_clear_duration}')).publish('CRIT')
		detect(ON_Condition_WARN, off=when(signal is None, '${var.jobs_failed_clear_duration}')).publish('WARN')
  EOF
...
resource "signalfx_detector" "list_jobs_failed" {
  ...
  program_text = <<-EOF
		...
		detect(ON_Condition_CRIT, off=when(signal is None, '${var.list_jobs_failed_clear_duration}')).publish('CRIT')
		detect(ON_Condition_WARN, off=when(signal is None, '${var.list_jobs_failed_clear_duration}')).publish('WARN')
  EOF
...
resource "signalfx_detector" "query_jobs_failed" {
  ...
  program_text = <<-EOF
		...
		detect(ON_Condition_CRIT, off=when(signal is None, '${var.query_jobs_failed_clear_duration}')).publish('CRIT')
		detect(ON_Condition_WARN, off=when(signal is None, '${var.query_jobs_failed_clear_duration}')).publish('WARN')
  EOF
...
resource "signalfx_detector" "c2d_methods_failed" {
  ...
  program_text = <<-EOF
		...
		detect(ON_Condition_CRIT, off=when(signal is None, '${var.c2d_methods_failed_clear_duration}')).publish('CRIT')
		detect(ON_Condition_WARN, off=when(signal is None, '${var.c2d_methods_failed_clear_duration}')).publish('WARN')
  EOF
...
resource "signalfx_detector" "c2d_twin_read_failed" {
  ...
  program_text = <<-EOF
		...
		detect(ON_Condition_CRIT, off=when(signal is None, '${var.c2d_twin_read_failed_clear_duration}')).publish('CRIT')
		detect(ON_Condition_WARN, off=when(signal is None, '${var.c2d_twin_read_failed_clear_duration}')).publish('WARN')
  EOF
...
resource "signalfx_detector" "c2d_twin_update_failed" {
  ...
  program_text = <<-EOF
		...
		detect(ON_Condition_CRIT, off=when(signal is None, '${var.c2d_twin_update_failed_clear_duration}')).publish('CRIT')
		detect(ON_Condition_WARN, off=when(signal is None, '${var.c2d_twin_update_failed_clear_duration}')).publish('WARN')
  EOF
...
resource "signalfx_detector" "d2c_twin_read_failed" {
  ...
  program_text = <<-EOF
		...
		detect(ON_Condition_CRIT, off=when(signal is None, '${var.d2c_twin_read_failed_clear_duration}')).publish('CRIT')
		detect(ON_Condition_WARN, off=when(signal is None, '${var.d2c_twin_read_failed_clear_duration}')).publish('WARN')
  EOF
...
resource "signalfx_detector" "d2c_twin_update_failed" {
  ...
  program_text = <<-EOF
		...
		detect(ON_Condition_CRIT, off=when(signal is None, '${var.d2c_twin_update_failed_clear_duration}')).publish('CRIT')
		detect(ON_Condition_WARN, off=when(signal is None, '${var.d2c_twin_update_failed_clear_duration}')).publish('WARN')
  EOF
...
resource "signalfx_detector" "d2c_telemetry_egress_dropped" {
  ...
  program_text = <<-EOF
		...
		detect(ON_Condition_CRIT, off=when(signal is None, '${var.d2c_telemetry_egress_dropped_clear_duration}')).publish('CRIT')
		detect(ON_Condition_WARN, off=when(signal is None, '${var.d2c_telemetry_egress_dropped_clear_duration}')).publish('WARN')
  EOF
...
resource "signalfx_detector" "d2c_telemetry_egress_orphaned" {
  ...
  program_text = <<-EOF
		...
		detect(ON_Condition_CRIT, off=when(signal is None, '${var.d2c_telemetry_egress_orphaned_clear_duration}')).publish('CRIT')
		detect(ON_Condition_WARN, off=when(signal is None, '${var.d2c_telemetry_egress_orphaned_clear_duration}')).publish('WARN')
  EOF
...
resource "signalfx_detector" "d2c_telemetry_egress_invalid" {
  ...
  program_text = <<-EOF
		...
		detect(ON_Condition_CRIT, off=when(signal is None, '${var.d2c_telemetry_egress_invalid_clear_duration}')).publish('CRIT')
		detect(ON_Condition_WARN, off=when(signal is None, '${var.d2c_telemetry_egress_invalid_clear_duration}')).publish('WARN')
  EOF
...
resource "signalfx_detector" "d2c_telemetry_ingress_nosent" {
  ...
  program_text = <<-EOF
		...
		detect(ON_Condition_CRIT, off=when(signal is None, '${var.d2c_telemetry_ingress_nosent_clear_duration}')).publish('CRIT')
		detect(ON_Condition_WARN, off=when(signal is None, '${var.d2c_telemetry_ingress_nosent_clear_duration}')).publish('WARN')
  EOF
