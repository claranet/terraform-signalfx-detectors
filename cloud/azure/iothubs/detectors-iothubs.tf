resource "signalfx_detector" "heartbeat" {
  ...
  program_text = <<-EOF
		...
		signal = data('EventGridDeliveries', filter=filter('resource_type', 'Microsoft.Devices/IotHubs') and filter('primary_aggregation_type', 'true') and (not filter('azure_power_state', 'PowerState/stopping', 'PowerState/stoppped', 'PowerState/deallocating', 'PowerState/deallocated')) and ${module.filter-tags.filter_custom}).publish('signal')
...
resource "signalfx_detector" "jobs_failed" {
  ...
  program_text = <<-EOF
		...
		ON_Condition_CRIT = conditions.generic_condition(signal, ${var.jobs_failed_threshold_critical}, ${var.jobs_failed_threshold_critical}, 'above', lasting('${var.jobs_failed_aperiodic_duration}', ${var.jobs_failed_aperiodic_percentage}), 'observed')
		ON_Condition_WARN = conditions.generic_condition(signal, ${var.jobs_failed_threshold_warning}, ${var.jobs_failed_threshold_critical}, 'within_range', lasting('${var.jobs_failed_aperiodic_duration}', ${var.jobs_failed_aperiodic_percentage}), 'observed', strict_2=False)
		detect(ON_Condition_CRIT, off=when(signal is None, '${var.jobs_failed_clear_duration}') or not ON_Condition_CRIT, mode='split').publish('CRIT')
		detect(ON_Condition_WARN, off=when(signal is None, '${var.jobs_failed_clear_duration}') or not ON_Condition_WARN, mode='split').publish('WARN')
  EOF
...
resource "signalfx_detector" "list_jobs_failed" {
  ...
  program_text = <<-EOF
		...
		ON_Condition_CRIT = conditions.generic_condition(signal, ${var.list_jobs_failed_threshold_critical}, ${var.list_jobs_failed_threshold_critical}, 'above', lasting('${var.list_jobs_failed_aperiodic_duration}', ${var.list_jobs_failed_aperiodic_percentage}), 'observed')
		ON_Condition_WARN = conditions.generic_condition(signal, ${var.list_jobs_failed_threshold_warning}, ${var.list_jobs_failed_threshold_critical}, 'within_range', lasting('${var.list_jobs_failed_aperiodic_duration}', ${var.list_jobs_failed_aperiodic_percentage}), 'observed', strict_2=False)
		detect(ON_Condition_CRIT, off=when(signal is None, '${var.list_jobs_failed_clear_duration}') or not ON_Condition_CRIT, mode='split').publish('CRIT')
		detect(ON_Condition_WARN, off=when(signal is None, '${var.list_jobs_failed_clear_duration}') or not ON_Condition_WARN, mode='split').publish('WARN')
  EOF
...
resource "signalfx_detector" "query_jobs_failed" {
  ...
  program_text = <<-EOF
		...
		ON_Condition_CRIT = conditions.generic_condition(signal, ${var.query_jobs_failed_threshold_critical}, ${var.query_jobs_failed_threshold_critical}, 'above', lasting('${var.query_jobs_failed_aperiodic_duration}', ${var.query_jobs_failed_aperiodic_percentage}), 'observed')
		ON_Condition_WARN = conditions.generic_condition(signal, ${var.query_jobs_failed_threshold_warning}, ${var.query_jobs_failed_threshold_critical}, 'within_range', lasting('${var.query_jobs_failed_aperiodic_duration}', ${var.query_jobs_failed_aperiodic_percentage}), 'observed', strict_2=False)
		detect(ON_Condition_CRIT, off=when(signal is None, '${var.query_jobs_failed_clear_duration}') or not ON_Condition_CRIT, mode='split').publish('CRIT')
		detect(ON_Condition_WARN, off=when(signal is None, '${var.query_jobs_failed_clear_duration}') or not ON_Condition_WARN, mode='split').publish('WARN')
  EOF
...
resource "signalfx_detector" "c2d_methods_failed" {
  ...
  program_text = <<-EOF
		...
		ON_Condition_CRIT = conditions.generic_condition(signal, ${var.c2d_methods_failed_threshold_critical}, ${var.c2d_methods_failed_threshold_critical}, 'above', lasting('${var.c2d_methods_failed_aperiodic_duration}', ${var.c2d_methods_failed_aperiodic_percentage}), 'observed')
		ON_Condition_WARN = conditions.generic_condition(signal, ${var.c2d_methods_failed_threshold_warning}, ${var.c2d_methods_failed_threshold_critical}, 'within_range', lasting('${var.c2d_methods_failed_aperiodic_duration}', ${var.c2d_methods_failed_aperiodic_percentage}), 'observed', strict_2=False)
		detect(ON_Condition_CRIT, off=when(signal is None, '${var.c2d_methods_failed_clear_duration}') or not ON_Condition_CRIT, mode='split').publish('CRIT')
		detect(ON_Condition_WARN, off=when(signal is None, '${var.c2d_methods_failed_clear_duration}') or not ON_Condition_WARN, mode='split').publish('WARN')
  EOF
...
resource "signalfx_detector" "c2d_twin_read_failed" {
  ...
  program_text = <<-EOF
		...
		ON_Condition_CRIT = conditions.generic_condition(signal, ${var.c2d_twin_read_failed_threshold_critical}, ${var.c2d_twin_read_failed_threshold_critical}, 'above', lasting('${var.c2d_twin_read_failed_aperiodic_duration}', ${var.c2d_twin_read_failed_aperiodic_percentage}), 'observed')
		ON_Condition_WARN = conditions.generic_condition(signal, ${var.c2d_twin_read_failed_threshold_warning}, ${var.c2d_twin_read_failed_threshold_critical}, 'within_range', lasting('${var.c2d_twin_read_failed_aperiodic_duration}', ${var.c2d_twin_read_failed_aperiodic_percentage}), 'observed', strict_2=False)
		detect(ON_Condition_CRIT, off=when(signal is None, '${var.c2d_twin_read_failed_clear_duration}') or not ON_Condition_CRIT, mode='split').publish('CRIT')
		detect(ON_Condition_WARN, off=when(signal is None, '${var.c2d_twin_read_failed_clear_duration}') or not ON_Condition_WARN, mode='split').publish('WARN')
  EOF
...
resource "signalfx_detector" "c2d_twin_update_failed" {
  ...
  program_text = <<-EOF
		...
		ON_Condition_CRIT = conditions.generic_condition(signal, ${var.c2d_twin_update_failed_threshold_critical}, ${var.c2d_twin_update_failed_threshold_critical}, 'above', lasting('${var.c2d_twin_update_failed_aperiodic_duration}', ${var.c2d_twin_update_failed_aperiodic_percentage}), 'observed')
		ON_Condition_WARN = conditions.generic_condition(signal, ${var.c2d_twin_update_failed_threshold_warning}, ${var.c2d_twin_update_failed_threshold_critical}, 'within_range', lasting('${var.c2d_twin_update_failed_aperiodic_duration}', ${var.c2d_twin_update_failed_aperiodic_percentage}), 'observed', strict_2=False)
		detect(ON_Condition_CRIT, off=when(signal is None, '${var.c2d_twin_update_failed_clear_duration}') or not ON_Condition_CRIT, mode='split').publish('CRIT')
		detect(ON_Condition_WARN, off=when(signal is None, '${var.c2d_twin_update_failed_clear_duration}') or not ON_Condition_WARN, mode='split').publish('WARN')
  EOF
...
resource "signalfx_detector" "d2c_twin_read_failed" {
  ...
  program_text = <<-EOF
		...
		ON_Condition_CRIT = conditions.generic_condition(signal, ${var.d2c_twin_read_failed_threshold_critical}, ${var.d2c_twin_read_failed_threshold_critical}, 'above', lasting('${var.d2c_twin_read_failed_aperiodic_duration}', ${var.d2c_twin_read_failed_aperiodic_percentage}), 'observed')
		ON_Condition_WARN = conditions.generic_condition(signal, ${var.d2c_twin_read_failed_threshold_warning}, ${var.d2c_twin_read_failed_threshold_critical}, 'within_range', lasting('${var.d2c_twin_read_failed_aperiodic_duration}', ${var.d2c_twin_read_failed_aperiodic_percentage}), 'observed', strict_2=False)
		detect(ON_Condition_CRIT, off=when(signal is None, '${var.d2c_twin_read_failed_clear_duration}') or not ON_Condition_CRIT, mode='split').publish('CRIT')
		detect(ON_Condition_WARN, off=when(signal is None, '${var.d2c_twin_read_failed_clear_duration}') or not ON_Condition_WARN, mode='split').publish('WARN')
  EOF
...
resource "signalfx_detector" "d2c_twin_update_failed" {
  ...
  program_text = <<-EOF
		...
		ON_Condition_CRIT = conditions.generic_condition(signal, ${var.d2c_twin_update_failed_threshold_critical}, ${var.d2c_twin_update_failed_threshold_critical}, 'above', lasting('${var.d2c_twin_update_failed_aperiodic_duration}', ${var.d2c_twin_update_failed_aperiodic_percentage}), 'observed')
		ON_Condition_WARN = conditions.generic_condition(signal, ${var.d2c_twin_update_failed_threshold_warning}, ${var.d2c_twin_update_failed_threshold_critical}, 'within_range', lasting('${var.d2c_twin_update_failed_aperiodic_duration}', ${var.d2c_twin_update_failed_aperiodic_percentage}), 'observed', strict_2=False)
		detect(ON_Condition_CRIT, off=when(signal is None, '${var.d2c_twin_update_failed_clear_duration}') or not ON_Condition_CRIT, mode='split').publish('CRIT')
		detect(ON_Condition_WARN, off=when(signal is None, '${var.d2c_twin_update_failed_clear_duration}') or not ON_Condition_WARN, mode='split').publish('WARN')
  EOF
...
resource "signalfx_detector" "d2c_telemetry_egress_dropped" {
  ...
  program_text = <<-EOF
		...
		ON_Condition_CRIT = conditions.generic_condition(signal, ${var.d2c_telemetry_egress_dropped_threshold_critical}, ${var.d2c_telemetry_egress_dropped_threshold_critical}, 'above', lasting('${var.d2c_telemetry_egress_dropped_aperiodic_duration}', ${var.d2c_telemetry_egress_dropped_aperiodic_percentage}), 'observed')
		ON_Condition_WARN = conditions.generic_condition(signal, ${var.d2c_telemetry_egress_dropped_threshold_warning}, ${var.d2c_telemetry_egress_dropped_threshold_critical}, 'within_range', lasting('${var.d2c_telemetry_egress_dropped_aperiodic_duration}', ${var.d2c_telemetry_egress_dropped_aperiodic_percentage}), 'observed', strict_2=False)
		detect(ON_Condition_CRIT, off=when(signal is None, '${var.d2c_telemetry_egress_dropped_clear_duration}') or not ON_Condition_CRIT, mode='split').publish('CRIT')
		detect(ON_Condition_WARN, off=when(signal is None, '${var.d2c_telemetry_egress_dropped_clear_duration}') or not ON_Condition_WARN, mode='split').publish('WARN')
  EOF
...
resource "signalfx_detector" "d2c_telemetry_egress_orphaned" {
  ...
  program_text = <<-EOF
		...
		ON_Condition_CRIT = conditions.generic_condition(signal, ${var.d2c_telemetry_egress_orphaned_threshold_critical}, ${var.d2c_telemetry_egress_orphaned_threshold_critical}, 'above', lasting('${var.d2c_telemetry_egress_orphaned_aperiodic_duration}', ${var.d2c_telemetry_egress_orphaned_aperiodic_percentage}), 'observed')
		ON_Condition_WARN = conditions.generic_condition(signal, ${var.d2c_telemetry_egress_orphaned_threshold_warning}, ${var.d2c_telemetry_egress_orphaned_threshold_critical}, 'within_range', lasting('${var.d2c_telemetry_egress_orphaned_aperiodic_duration}', ${var.d2c_telemetry_egress_orphaned_aperiodic_percentage}), 'observed', strict_2=False)
		detect(ON_Condition_CRIT, off=when(signal is None, '${var.d2c_telemetry_egress_orphaned_clear_duration}') or not ON_Condition_CRIT, mode='split').publish('CRIT')
		detect(ON_Condition_WARN, off=when(signal is None, '${var.d2c_telemetry_egress_orphaned_clear_duration}') or not ON_Condition_WARN, mode='split').publish('WARN')
  EOF
...
resource "signalfx_detector" "d2c_telemetry_egress_invalid" {
  ...
  program_text = <<-EOF
		...
		ON_Condition_CRIT = conditions.generic_condition(signal, ${var.d2c_telemetry_egress_invalid_threshold_critical}, ${var.d2c_telemetry_egress_invalid_threshold_critical}, 'above', lasting('${var.d2c_telemetry_egress_invalid_aperiodic_duration}', ${var.d2c_telemetry_egress_invalid_aperiodic_percentage}), 'observed')
		ON_Condition_WARN = conditions.generic_condition(signal, ${var.d2c_telemetry_egress_invalid_threshold_warning}, ${var.d2c_telemetry_egress_invalid_threshold_critical}, 'within_range', lasting('${var.d2c_telemetry_egress_invalid_aperiodic_duration}', ${var.d2c_telemetry_egress_invalid_aperiodic_percentage}), 'observed', strict_2=False)
		detect(ON_Condition_CRIT, off=when(signal is None, '${var.d2c_telemetry_egress_invalid_clear_duration}') or not ON_Condition_CRIT, mode='split').publish('CRIT')
		detect(ON_Condition_WARN, off=when(signal is None, '${var.d2c_telemetry_egress_invalid_clear_duration}') or not ON_Condition_WARN, mode='split').publish('WARN')
  EOF
...
resource "signalfx_detector" "d2c_telemetry_ingress_nosent" {
  ...
  program_text = <<-EOF
		...
		ON_Condition_CRIT = conditions.generic_condition(signal, ${var.d2c_telemetry_ingress_nosent_threshold_critical}, ${var.d2c_telemetry_ingress_nosent_threshold_critical}, 'above', lasting('${var.d2c_telemetry_ingress_nosent_aperiodic_duration}', ${var.d2c_telemetry_ingress_nosent_aperiodic_percentage}), 'observed')
		ON_Condition_WARN = conditions.generic_condition(signal, ${var.d2c_telemetry_ingress_nosent_threshold_warning}, ${var.d2c_telemetry_ingress_nosent_threshold_critical}, 'within_range', lasting('${var.d2c_telemetry_ingress_nosent_aperiodic_duration}', ${var.d2c_telemetry_ingress_nosent_aperiodic_percentage}), 'observed', strict_2=False)
		detect(ON_Condition_CRIT, off=when(signal is None, '${var.d2c_telemetry_ingress_nosent_clear_duration}') or not ON_Condition_CRIT, mode='split').publish('CRIT')
		detect(ON_Condition_WARN, off=when(signal is None, '${var.d2c_telemetry_ingress_nosent_clear_duration}') or not ON_Condition_WARN, mode='split').publish('WARN')
  EOF
