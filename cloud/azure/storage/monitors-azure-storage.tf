resource "signalfx_detector" "heartbeat" {
	...
	program_text = <<-EOF
		...
		signal = data('Transactions', filter=filter('resource_type', 'Microsoft.Storage/storageAccounts') and ${module.filter-tags.filter_custom})
...
resource "signalfx_detector" "blobservices_requests_error" {
	...
	program_text = <<-EOF
		...
		signal = (100-(A/B)).scale(100).${var.blobservices_requests_error_transformation_function}(over='${var.blobservices_requests_error_transformation_window}')
		detect(when(signal > ${var.blobservices_requests_error_threshold_critical})).publish('CRIT')
		detect(when(signal > ${var.blobservices_requests_error_threshold_warning})).publish('WARN')
	EOF
...
resource "signalfx_detector" "fileservices_requests_error" {
	...
	program_text = <<-EOF
		...
		signal = (100-(A/B)).scale(100).${var.fileservices_requests_error_transformation_function}(over='${var.fileservices_requests_error_transformation_window}')
		detect(when(signal > ${var.fileservices_requests_error_threshold_critical})).publish('CRIT')
		detect(when(signal > ${var.fileservices_requests_error_threshold_warning})).publish('WARN')
	EOF
...
resource "signalfx_detector" "queueservices_requests_error" {
	...
	program_text = <<-EOF
		...
		signal = (100-(A/B)).scale(100).${var.queueservices_requests_error_transformation_function}(over='${var.queueservices_requests_error_transformation_window}')
		detect(when(signal > ${var.queueservices_requests_error_threshold_critical})).publish('CRIT')
		detect(when(signal > ${var.queueservices_requests_error_threshold_warning})).publish('WARN')
	EOF
...
resource "signalfx_detector" "tableservices_requests_error" {
	...
	program_text = <<-EOF
		...
		signal = (100-(A/B)).scale(100).${var.tableservices_requests_error_transformation_function}(over='${var.tableservices_requests_error_transformation_window}')
		detect(when(signal > ${var.tableservices_requests_error_threshold_critical})).publish('CRIT')
		detect(when(signal > ${var.tableservices_requests_error_threshold_warning})).publish('WARN')
	EOF
...
resource "signalfx_detector" "blobservices_latency" {
	...
	program_text = <<-EOF
		signal = data('SuccessE2ELatency', filter=filter('resource_type', 'Microsoft.Storage/storageAccounts/blobServices') and ${module.filter-tags.filter_custom})${var.blobservices_latency_aggregation_function}.${var.blobservices_latency_transformation_function}(over='${var.blobservices_latency_transformation_window}')
		detect(when(signal > ${var.blobservices_latency_threshold_critical})).publish('CRIT')
		detect(when(signal > ${var.blobservices_latency_threshold_warning})).publish('WARN')
	EOF
...
resource "signalfx_detector" "fileservices_latency" {
	...
	program_text = <<-EOF
		signal = data('SuccessE2ELatency', filter=filter('resource_type', 'Microsoft.Storage/storageAccounts/fileServices') and ${module.filter-tags.filter_custom})${var.fileservices_latency_aggregation_function}.${var.fileservices_latency_transformation_function}(over='${var.fileservices_latency_transformation_window}')
		detect(when(signal > ${var.fileservices_latency_threshold_critical})).publish('CRIT')
		detect(when(signal > ${var.fileservices_latency_threshold_warning})).publish('WARN')
...
resource "signalfx_detector" "queueservices_latency" {
	...
	program_text = <<-EOF
		signal = data('SuccessE2ELatency', filter=filter('resource_type', 'Microsoft.Storage/storageAccounts/queueServices') and ${module.filter-tags.filter_custom})${var.queueservices_latency_aggregation_function}.${var.queueservices_latency_transformation_function}(over='${var.queueservices_latency_transformation_window}')
		detect(when(signal > ${var.queueservices_latency_threshold_critical})).publish('CRIT')
		detect(when(signal > ${var.queueservices_latency_threshold_warning})).publish('WARN')
	EOF
...
resource "signalfx_detector" "tableservices_latency" {
	...
	program_text = <<-EOF
		signal = data('SuccessE2ELatency', filter=filter('resource_type', 'Microsoft.Storage/storageAccounts/tableServices') and ${module.filter-tags.filter_custom}){var.tableservices_latency_aggregation_function}.${var.tableservices_latency_transformation_function}(over='${var.tableservices_latency_transformation_window}')
		detect(when(signal > ${var.tableservices_latency_threshold_critical})).publish('CRIT')
		detect(when(signal > ${var.tableservices_latency_threshold_warning})).publish('WARN')
	EOF
...
resource "signalfx_detector" "blob_timeout_error_requests" {
	...
	program_text = <<-EOF
		...
		signal = (A/B).scale(100).${var.blob_timeout_error_requests_transformation_function}(over='${var.blob_timeout_error_requests_transformation_window}')
		detect(when(signal > ${var.blob_timeout_error_requests_threshold_critical})).publish('CRIT')
		detect(when(signal > ${var.blob_timeout_error_requests_threshold_warning})).publish('WARN')
	EOF
...
resource "signalfx_detector" "file_timeout_error_requests" {
	...
	program_text = <<-EOF
		...
		signal = (A/B).scale(100).${var.file_timeout_error_requests_transformation_function}(over='${var.file_timeout_error_requests_transformation_window}')
		detect(when(signal > ${var.file_timeout_error_requests_threshold_critical})).publish('CRIT')
		detect(when(signal > ${var.file_timeout_error_requests_threshold_warning})).publish('WARN')
	EOF
...
resource "signalfx_detector" "queue_timeout_error_requests" {
	...
	program_text = <<-EOF
		...
		signal = (A/B).scale(100).${var.queue_timeout_error_requests_transformation_function}(over='${var.queue_timeout_error_requests_transformation_window}')
		detect(when(signal > ${var.queue_timeout_error_requests_threshold_critical})).publish('CRIT')
		detect(when(signal > ${var.queue_timeout_error_requests_threshold_warning})).publish('WARN')
	EOF
...
resource "signalfx_detector" "table_timeout_error_requests" {
	...
	program_text = <<-EOF
		...
		signal = (A/B).scale(100).${var.table_timeout_error_requests_transformation_function}(over='${var.table_timeout_error_requests_transformation_window}')
		detect(when(signal > ${var.table_timeout_error_requests_threshold_critical})).publish('CRIT')
		detect(when(signal > ${var.table_timeout_error_requests_threshold_warning})).publish('WARN')
	EOF
...
resource "signalfx_detector" "blob_network_error_requests" {
	...
	program_text = <<-EOF
		...
		signal = (A/B).scale(100).${var.blob_network_error_requests_transformation_function}(over='${var.blob_network_error_requests_transformation_window}')
		detect(when(signal > ${var.blob_network_error_requests_threshold_critical})).publish('CRIT')
		detect(when(signal > ${var.blob_network_error_requests_threshold_warning})).publish('WARN')
	EOF
...
resource "signalfx_detector" "file_network_error_requests" {
	...
	program_text = <<-EOF
		...
		signal = (A/B).scale(100).${var.file_network_error_requests_transformation_function}(over='${var.file_network_error_requests_transformation_window}')
		detect(when(signal > ${var.file_network_error_requests_threshold_critical})).publish('CRIT')
		detect(when(signal > ${var.file_network_error_requests_threshold_warning})).publish('WARN')
	EOF
...
resource "signalfx_detector" "queue_network_error_requests" {
	...
	program_text = <<-EOF
		...
		signal = (A/B).scale(100).${var.queue_network_error_requests_transformation_function}(over='${var.queue_network_error_requests_transformation_window}')
		detect(when(signal > ${var.queue_network_error_requests_threshold_critical})).publish('CRIT')
		detect(when(signal > ${var.queue_network_error_requests_threshold_warning})).publish('WARN')
	EOF
...
resource "signalfx_detector" "table_network_error_requests" {
	...
	program_text = <<-EOF
		...
		signal = (A/B).scale(100).${var.table_network_error_requests_transformation_function}(over='${var.table_network_error_requests_transformation_window}')
		detect(when(signal > ${var.table_network_error_requests_threshold_critical})).publish('CRIT')
		detect(when(signal > ${var.table_network_error_requests_threshold_warning})).publish('WARN')
	EOF
...
resource "signalfx_detector" "blob_throttling_error_requests" {
	...
	program_text = <<-EOF
		...
		signal = (A/B).scale(100).${var.blob_throttling_error_requests_transformation_function}(over='${var.blob_throttling_error_requests_transformation_window}')
		detect(when(signal > ${var.blob_throttling_error_requests_threshold_critical})).publish('CRIT')
		detect(when(signal > ${var.blob_throttling_error_requests_threshold_warning})).publish('WARN')
	EOF
...
resource "signalfx_detector" "file_throttling_error_requests" {
	...
	program_text = <<-EOF
		...
		signal = (A/B).scale(100).${var.file_throttling_error_requests_transformation_function}(over='${var.file_throttling_error_requests_transformation_window}')
		detect(when(signal > ${var.file_throttling_error_requests_threshold_critical})).publish('CRIT')
		detect(when(signal > ${var.file_throttling_error_requests_threshold_warning})).publish('WARN')
	EOF
...
resource "signalfx_detector" "queue_throttling_error_requests" {
	...
	program_text = <<-EOF
		...
		signal = (A/B).scale(100).${var.queue_throttling_error_requests_transformation_function}(over='${var.queue_throttling_error_requests_transformation_window}')
		detect(when(signal > ${var.queue_throttling_error_requests_threshold_critical})).publish('CRIT')
		detect(when(signal > ${var.queue_throttling_error_requests_threshold_warning})).publish('WARN')
	EOF
...
resource "signalfx_detector" "table_throttling_error_requests" {
	...
	program_text = <<-EOF
		...
		signal = (A/B).scale(100).${var.table_throttling_error_requests_transformation_function}(over='${var.table_throttling_error_requests_transformation_window}')
		detect(when(signal > ${var.table_throttling_error_requests_threshold_critical})).publish('CRIT')
		detect(when(signal > ${var.table_throttling_error_requests_threshold_warning})).publish('WARN')
	EOF
...
resource "signalfx_detector" "blob_server_other_error_requests" {
	...
	program_text = <<-EOF
		...
		signal = (A/B).scale(100).${var.blob_server_other_error_requests_transformation_function}(over='${var.blob_server_other_error_requests_transformation_window}')
		detect(when(signal > ${var.blob_server_other_error_requests_threshold_critical})).publish('CRIT')
		detect(when(signal > ${var.blob_server_other_error_requests_threshold_warning})).publish('WARN')
	EOF
...
resource "signalfx_detector" "file_server_other_error_requests" {
	...
	program_text = <<-EOF
		...
		signal = (A/B).scale(100).${var.file_server_other_error_requests_transformation_function}(over='${var.file_server_other_error_requests_transformation_window}')
		detect(when(signal > ${var.file_server_other_error_requests_threshold_critical})).publish('CRIT')
		detect(when(signal > ${var.file_server_other_error_requests_threshold_warning})).publish('WARN')
	EOF
...
resource "signalfx_detector" "queue_server_other_error_requests" {
	...
	program_text = <<-EOF
		...
		signal = (A/B).scale(100).${var.queue_server_other_error_requests_transformation_function}(over='${var.queue_server_other_error_requests_transformation_window}')
		detect(when(signal > ${var.queue_server_other_error_requests_threshold_critical})).publish('CRIT')
		detect(when(signal > ${var.queue_server_other_error_requests_threshold_warning})).publish('WARN')
	EOF
...
resource "signalfx_detector" "table_server_other_error_requests" {
	...
	program_text = <<-EOF
		...
		signal = (A/B).scale(100).${var.table_server_other_error_requests_transformation_function}(over='${var.table_server_other_error_requests_transformation_window}')
		detect(when(signal > ${var.table_server_other_error_requests_threshold_critical})).publish('CRIT')
		detect(when(signal > ${var.table_server_other_error_requests_threshold_warning})).publish('WARN')
	EOF
...
resource "signalfx_detector" "blob_client_other_error_requests" {
	...
	program_text = <<-EOF
		...
		signal = (A/B).scale(100).${var.blob_client_other_error_requests_transformation_function}(over='${var.blob_client_other_error_requests_transformation_window}')
		detect(when(signal > ${var.blob_client_other_error_requests_threshold_critical})).publish('CRIT')
		detect(when(signal > ${var.blob_client_other_error_requests_threshold_warning})).publish('WARN')
	EOF
...
resource "signalfx_detector" "file_client_other_error_requests" {
	...
	program_text = <<-EOF
		...
		signal = (A/B).scale(100).${var.file_client_other_error_requests_transformation_function}(over='${var.file_client_other_error_requests_transformation_window}')
		detect(when(signal > ${var.file_client_other_error_requests_threshold_critical})).publish('CRIT')
		detect(when(signal > ${var.file_client_other_error_requests_threshold_warning})).publish('WARN')
	EOF
...
resource "signalfx_detector" "queue_client_other_error_requests" {
	...
	program_text = <<-EOF
		...
		signal = (A/B).scale(100).${var.queue_client_other_error_requests_transformation_function}(over='${var.queue_client_other_error_requests_transformation_window}')
		detect(when(signal > ${var.queue_client_other_error_requests_threshold_critical})).publish('CRIT')
		detect(when(signal > ${var.queue_client_other_error_requests_threshold_warning})).publish('WARN')
	EOF
...
resource "signalfx_detector" "table_client_other_error_requests" {
	...
	program_text = <<-EOF
		...
		signal = (A/B).scale(100).${var.table_client_other_error_requests_transformation_function}(over='${var.table_client_other_error_requests_transformation_window}')
		detect(when(signal > ${var.table_client_other_error_requests_threshold_critical})).publish('CRIT')
		detect(when(signal > ${var.table_client_other_error_requests_threshold_warning})).publish('WARN')
	EOF
...
resource "signalfx_detector" "blob_authorization_error_requests" {
	...
	program_text = <<-EOF
		...
		signal = (A/B).scale(100).${var.blob_authorization_error_requests_transformation_function}(over='${var.blob_authorization_error_requests_transformation_window}')
		detect(when(signal > ${var.blob_authorization_error_requests_threshold_critical})).publish('CRIT')
		detect(when(signal > ${var.blob_authorization_error_requests_threshold_warning})).publish('WARN')
	EOF
...
resource "signalfx_detector" "file_authorization_error_requests" {
	...
	program_text = <<-EOF
		...
		signal = (A/B).scale(100).${var.file_authorization_error_requests_transformation_function}(over='${var.file_authorization_error_requests_transformation_window}')
		detect(when(signal > ${var.file_authorization_error_requests_threshold_critical})).publish('CRIT')
		detect(when(signal > ${var.file_authorization_error_requests_threshold_warning})).publish('WARN')
	EOF
...
resource "signalfx_detector" "queue_authorization_error_requests" {
	...
	program_text = <<-EOF
		...
		signal = (A/B).scale(100).${var.queue_authorization_error_requests_transformation_function}(over='${var.queue_authorization_error_requests_transformation_window}')
		detect(when(signal > ${var.queue_authorization_error_requests_threshold_critical})).publish('CRIT')
		detect(when(signal > ${var.queue_authorization_error_requests_threshold_warning})).publish('WARN')
	EOF
...
resource "signalfx_detector" "table_authorization_error_requests" {
	...
	program_text = <<-EOF
		...
		signal = (A/B).scale(100).${var.table_authorization_error_requests_transformation_function}(over='${var.table_authorization_error_requests_transformation_window}')
		detect(when(signal > ${var.table_authorization_error_requests_threshold_critical})).publish('CRIT')
		detect(when(signal > ${var.table_authorization_error_requests_threshold_warning})).publish('WARN')
	EOF
