...
resource "signalfx_detector" "blobservices_requests_error" {
  ...
  program_text = <<-EOF
		...
		signal = (100-((A/B)*100)).${var.blobservices_requests_error_transformation_function}(over='${var.blobservices_requests_error_transformation_window}').publish('signal')
		...
		detect(ON_Condition_CRIT, off=when(signal is None, '${var.blobservices_requests_error_clear_duration}') or not ON_Condition_CRIT, mode='split').publish('CRIT')
		detect(ON_Condition_WARN, off=when(signal is None, '${var.blobservices_requests_error_clear_duration}') or not ON_Condition_WARN, mode='split').publish('WARN')
  EOF
...
resource "signalfx_detector" "fileservices_requests_error" {
  ...
  program_text = <<-EOF
		...
		signal = (100-((A/B)*100)).${var.fileservices_requests_error_transformation_function}(over='${var.fileservices_requests_error_transformation_window}').publish('signal')
		...
		detect(ON_Condition_CRIT, off=when(signal is None, '${var.fileservices_requests_error_clear_duration}') or not ON_Condition_CRIT, mode='split').publish('CRIT')
		detect(ON_Condition_WARN, off=when(signal is None, '${var.fileservices_requests_error_clear_duration}') or not ON_Condition_WARN, mode='split').publish('WARN')
  EOF
...
resource "signalfx_detector" "queueservices_requests_error" {
  ...
  program_text = <<-EOF
		...
		signal = (100-((A/B)*100)).${var.queueservices_requests_error_transformation_function}(over='${var.queueservices_requests_error_transformation_window}').publish('signal')
		...
		detect(ON_Condition_CRIT, off=when(signal is None, '${var.queueservices_requests_error_clear_duration}') or not ON_Condition_CRIT, mode='split').publish('CRIT')
		detect(ON_Condition_WARN, off=when(signal is None, '${var.queueservices_requests_error_clear_duration}') or not ON_Condition_WARN, mode='split').publish('WARN')
  EOF
...
resource "signalfx_detector" "tableservices_requests_error" {
  ...
  program_text = <<-EOF
		...
		signal = (100-((A/B)*100)).${var.tableservices_requests_error_transformation_function}(over='${var.tableservices_requests_error_transformation_window}').publish('signal')
		...
		detect(ON_Condition_CRIT, off=when(signal is None, '${var.tableservices_requests_error_clear_duration}') or not ON_Condition_CRIT, mode='split').publish('CRIT')
		detect(ON_Condition_WARN, off=when(signal is None, '${var.tableservices_requests_error_clear_duration}') or not ON_Condition_WARN, mode='split').publish('WARN')
  EOF
...
resource "signalfx_detector" "blobservices_latency" {
  ...
  program_text = <<-EOF
		...
		detect(ON_Condition_CRIT, off=when(signal is None, '${var.blobservices_latency_clear_duration}') or not ON_Condition_CRIT, mode='split').publish('CRIT')
		detect(ON_Condition_WARN, off=when(signal is None, '${var.blobservices_latency_clear_duration}') or not ON_Condition_WARN, mode='split').publish('WARN')
  EOF
...
resource "signalfx_detector" "fileservices_latency" {
  ...
  program_text = <<-EOF
		...
		detect(ON_Condition_CRIT, off=when(signal is None, '${var.fileservices_latency_clear_duration}') or not ON_Condition_CRIT, mode='split').publish('CRIT')
		detect(ON_Condition_WARN, off=when(signal is None, '${var.fileservices_latency_clear_duration}') or not ON_Condition_WARN, mode='split').publish('WARN')
  EOF
...
resource "signalfx_detector" "queueservices_latency" {
  ...
  program_text = <<-EOF
		...
		detect(ON_Condition_CRIT, off=when(signal is None, '${var.queueservices_latency_clear_duration}') or not ON_Condition_CRIT, mode='split').publish('CRIT')
		detect(ON_Condition_WARN, off=when(signal is None, '${var.queueservices_latency_clear_duration}') or not ON_Condition_WARN, mode='split').publish('WARN')
  EOF
...
resource "signalfx_detector" "tableservices_latency" {
  ...
  program_text = <<-EOF
		...
		detect(ON_Condition_CRIT, off=when(signal is None, '${var.tableservices_latency_clear_duration}') or not ON_Condition_CRIT, mode='split').publish('CRIT')
		detect(ON_Condition_WARN, off=when(signal is None, '${var.tableservices_latency_clear_duration}') or not ON_Condition_WARN, mode='split').publish('WARN')
  EOF
...
resource "signalfx_detector" "blob_timeout_error_requests" {
  ...
  program_text = <<-EOF
		...
		detect(ON_Condition_CRIT, off=when(signal is None, '${var.blob_timeout_error_requests_clear_duration}') or not ON_Condition_CRIT, mode='split').publish('CRIT')
		detect(ON_Condition_WARN, off=when(signal is None, '${var.blob_timeout_error_requests_clear_duration}') or not ON_Condition_WARN, mode='split').publish('WARN')
  EOF
...
resource "signalfx_detector" "file_timeout_error_requests" {
  ...
  program_text = <<-EOF
		...
		detect(ON_Condition_CRIT, off=when(signal is None, '${var.file_timeout_error_requests_clear_duration}') or not ON_Condition_CRIT, mode='split').publish('CRIT')
		detect(ON_Condition_WARN, off=when(signal is None, '${var.file_timeout_error_requests_clear_duration}') or not ON_Condition_WARN, mode='split').publish('WARN')
  EOF
...
resource "signalfx_detector" "queue_timeout_error_requests" {
  ...
  program_text = <<-EOF
		...
		detect(ON_Condition_CRIT, off=when(signal is None, '${var.queue_timeout_error_requests_clear_duration}') or not ON_Condition_CRIT, mode='split').publish('CRIT')
		detect(ON_Condition_WARN, off=when(signal is None, '${var.queue_timeout_error_requests_clear_duration}') or not ON_Condition_WARN, mode='split').publish('WARN')
  EOF
...
resource "signalfx_detector" "table_timeout_error_requests" {
  ...
  program_text = <<-EOF
		...
		detect(ON_Condition_CRIT, off=when(signal is None, '${var.table_timeout_error_requests_clear_duration}') or not ON_Condition_CRIT, mode='split').publish('CRIT')
		detect(ON_Condition_WARN, off=when(signal is None, '${var.table_timeout_error_requests_clear_duration}') or not ON_Condition_WARN, mode='split').publish('WARN')
  EOF
...
resource "signalfx_detector" "blob_network_error_requests" {
  ...
  program_text = <<-EOF
		...
		detect(ON_Condition_CRIT, off=when(signal is None, '${var.blob_network_error_requests_clear_duration}') or not ON_Condition_CRIT, mode='split').publish('CRIT')
		detect(ON_Condition_WARN, off=when(signal is None, '${var.blob_network_error_requests_clear_duration}') or not ON_Condition_WARN, mode='split').publish('WARN')
  EOF
...
resource "signalfx_detector" "file_network_error_requests" {
  ...
  program_text = <<-EOF
		...
		detect(ON_Condition_CRIT, off=when(signal is None, '${var.file_network_error_requests_clear_duration}') or not ON_Condition_CRIT, mode='split').publish('CRIT')
		detect(ON_Condition_WARN, off=when(signal is None, '${var.file_network_error_requests_clear_duration}') or not ON_Condition_WARN, mode='split').publish('WARN')
  EOF
...
resource "signalfx_detector" "queue_network_error_requests" {
  ...
  program_text = <<-EOF
		...
		detect(ON_Condition_CRIT, off=when(signal is None, '${var.queue_network_error_requests_clear_duration}') or not ON_Condition_CRIT, mode='split').publish('CRIT')
		detect(ON_Condition_WARN, off=when(signal is None, '${var.queue_network_error_requests_clear_duration}') or not ON_Condition_WARN, mode='split').publish('WARN')
  EOF
...
resource "signalfx_detector" "table_network_error_requests" {
  ...
  program_text = <<-EOF
		...
		detect(ON_Condition_CRIT, off=when(signal is None, '${var.table_network_error_requests_clear_duration}') or not ON_Condition_CRIT, mode='split').publish('CRIT')
		detect(ON_Condition_WARN, off=when(signal is None, '${var.table_network_error_requests_clear_duration}') or not ON_Condition_WARN, mode='split').publish('WARN')
  EOF
...
resource "signalfx_detector" "blob_throttling_error_requests" {
  ...
  program_text = <<-EOF
		...
		detect(ON_Condition_CRIT, off=when(signal is None, '${var.blob_throttling_error_requests_clear_duration}') or not ON_Condition_CRIT, mode='split').publish('CRIT')
		detect(ON_Condition_WARN, off=when(signal is None, '${var.blob_throttling_error_requests_clear_duration}') or not ON_Condition_WARN, mode='split').publish('WARN')
  EOF
...
resource "signalfx_detector" "file_throttling_error_requests" {
  ...
  program_text = <<-EOF
		...
		detect(ON_Condition_CRIT, off=when(signal is None, '${var.file_throttling_error_requests_clear_duration}') or not ON_Condition_CRIT, mode='split').publish('CRIT')
		detect(ON_Condition_WARN, off=when(signal is None, '${var.file_throttling_error_requests_clear_duration}') or not ON_Condition_WARN, mode='split').publish('WARN')
  EOF
...
resource "signalfx_detector" "queue_throttling_error_requests" {
  ...
  program_text = <<-EOF
		...
		detect(ON_Condition_CRIT, off=when(signal is None, '${var.queue_throttling_error_requests_clear_duration}') or not ON_Condition_CRIT, mode='split').publish('CRIT')
		detect(ON_Condition_WARN, off=when(signal is None, '${var.queue_throttling_error_requests_clear_duration}') or not ON_Condition_WARN, mode='split').publish('WARN')
  EOF
...
resource "signalfx_detector" "table_throttling_error_requests" {
  ...
  program_text = <<-EOF
		...
		detect(ON_Condition_CRIT, off=when(signal is None, '${var.table_throttling_error_requests_clear_duration}') or not ON_Condition_CRIT, mode='split').publish('CRIT')
		detect(ON_Condition_WARN, off=when(signal is None, '${var.table_throttling_error_requests_clear_duration}') or not ON_Condition_WARN, mode='split').publish('WARN')
  EOF
...
resource "signalfx_detector" "blob_server_other_error_requests" {
  ...
  program_text = <<-EOF
		...
		detect(ON_Condition_CRIT, off=when(signal is None, '${var.blob_server_other_error_requests_clear_duration}') or not ON_Condition_CRIT, mode='split').publish('CRIT')
		detect(ON_Condition_WARN, off=when(signal is None, '${var.blob_server_other_error_requests_clear_duration}') or not ON_Condition_WARN, mode='split').publish('WARN')
  EOF
...
resource "signalfx_detector" "file_server_other_error_requests" {
  ...
  program_text = <<-EOF
		...
		detect(ON_Condition_CRIT, off=when(signal is None, '${var.file_server_other_error_requests_clear_duration}') or not ON_Condition_CRIT, mode='split').publish('CRIT')
		detect(ON_Condition_WARN, off=when(signal is None, '${var.file_server_other_error_requests_clear_duration}') or not ON_Condition_WARN, mode='split').publish('WARN')
  EOF
...
resource "signalfx_detector" "queue_server_other_error_requests" {
  ...
  program_text = <<-EOF
		...
		detect(ON_Condition_CRIT, off=when(signal is None, '${var.queue_server_other_error_requests_clear_duration}') or not ON_Condition_CRIT, mode='split').publish('CRIT')
		detect(ON_Condition_WARN, off=when(signal is None, '${var.queue_server_other_error_requests_clear_duration}') or not ON_Condition_WARN, mode='split').publish('WARN')
  EOF
...
resource "signalfx_detector" "table_server_other_error_requests" {
  ...
  program_text = <<-EOF
		...
		detect(ON_Condition_CRIT, off=when(signal is None, '${var.table_server_other_error_requests_clear_duration}') or not ON_Condition_CRIT, mode='split').publish('CRIT')
		detect(ON_Condition_WARN, off=when(signal is None, '${var.table_server_other_error_requests_clear_duration}') or not ON_Condition_WARN, mode='split').publish('WARN')
  EOF
...
resource "signalfx_detector" "blob_client_other_error_requests" {
  ...
  program_text = <<-EOF
		...
		detect(ON_Condition_CRIT, off=when(signal is None, '${var.blob_client_other_error_requests_clear_duration}') or not ON_Condition_CRIT, mode='split').publish('CRIT')
		detect(ON_Condition_WARN, off=when(signal is None, '${var.blob_client_other_error_requests_clear_duration}') or not ON_Condition_WARN, mode='split').publish('WARN')
  EOF
...
resource "signalfx_detector" "file_client_other_error_requests" {
  ...
  program_text = <<-EOF
		...
		detect(ON_Condition_CRIT, off=when(signal is None, '${var.file_client_other_error_requests_clear_duration}') or not ON_Condition_CRIT, mode='split').publish('CRIT')
		detect(ON_Condition_WARN, off=when(signal is None, '${var.file_client_other_error_requests_clear_duration}') or not ON_Condition_WARN, mode='split').publish('WARN')
  EOF
...
resource "signalfx_detector" "queue_client_other_error_requests" {
  ...
  program_text = <<-EOF
		...
		detect(ON_Condition_CRIT, off=when(signal is None, '${var.queue_client_other_error_requests_clear_duration}') or not ON_Condition_CRIT, mode='split').publish('CRIT')
		detect(ON_Condition_WARN, off=when(signal is None, '${var.queue_client_other_error_requests_clear_duration}') or not ON_Condition_WARN, mode='split').publish('WARN')
  EOF
...
resource "signalfx_detector" "table_client_other_error_requests" {
  ...
  program_text = <<-EOF
		...
		detect(ON_Condition_CRIT, off=when(signal is None, '${var.table_client_other_error_requests_clear_duration}') or not ON_Condition_CRIT, mode='split').publish('CRIT')
		detect(ON_Condition_WARN, off=when(signal is None, '${var.table_client_other_error_requests_clear_duration}') or not ON_Condition_WARN, mode='split').publish('WARN')
  EOF
...
resource "signalfx_detector" "blob_authorization_error_requests" {
  ...
  program_text = <<-EOF
		...
		detect(ON_Condition_CRIT, off=when(signal is None, '${var.blob_authorization_error_requests_clear_duration}') or not ON_Condition_CRIT, mode='split').publish('CRIT')
		detect(ON_Condition_WARN, off=when(signal is None, '${var.blob_authorization_error_requests_clear_duration}') or not ON_Condition_WARN, mode='split').publish('WARN')
  EOF
...
resource "signalfx_detector" "file_authorization_error_requests" {
  ...
  program_text = <<-EOF
		...
		detect(ON_Condition_CRIT, off=when(signal is None, '${var.file_authorization_error_requests_clear_duration}') or not ON_Condition_CRIT, mode='split').publish('CRIT')
		detect(ON_Condition_WARN, off=when(signal is None, '${var.file_authorization_error_requests_clear_duration}') or not ON_Condition_WARN, mode='split').publish('WARN')
  EOF
...
resource "signalfx_detector" "queue_authorization_error_requests" {
  ...
  program_text = <<-EOF
		...
		detect(ON_Condition_CRIT, off=when(signal is None, '${var.queue_authorization_error_requests_clear_duration}') or not ON_Condition_CRIT, mode='split').publish('CRIT')
		detect(ON_Condition_WARN, off=when(signal is None, '${var.queue_authorization_error_requests_clear_duration}') or not ON_Condition_WARN, mode='split').publish('WARN')
  EOF
...
resource "signalfx_detector" "table_authorization_error_requests" {
  ...
  program_text = <<-EOF
		...
		detect(ON_Condition_CRIT, off=when(signal is None, '${var.table_authorization_error_requests_clear_duration}') or not ON_Condition_CRIT, mode='split').publish('CRIT')
		detect(ON_Condition_WARN, off=when(signal is None, '${var.table_authorization_error_requests_clear_duration}') or not ON_Condition_WARN, mode='split').publish('WARN')
  EOF
