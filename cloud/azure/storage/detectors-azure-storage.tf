...
resource "signalfx_detector" "blobservices_requests_error" {
	...
	program_text = <<-EOF
		...
		aperiodic.range_detector(signal, ${var.blobservices_requests_error_threshold_warning}, ${var.blobservices_requests_error_threshold_critical}, 'within_range', lasting('${var.blobservices_requests_error_aperiodic_duration}', ${var.blobservices_requests_error_aperiodic_percentage}), upper_strict=${var.blobservices_requests_error_aperiodic_upper_strict}).publish('WARN')
	EOF
...
resource "signalfx_detector" "fileservices_requests_error" {
	...
	program_text = <<-EOF
		...
		aperiodic.range_detector(signal, ${var.fileservices_requests_error_threshold_warning}, ${var.fileservices_requests_error_threshold_critical}, 'within_range', lasting('${var.fileservices_requests_error_aperiodic_duration}', ${var.fileservices_requests_error_aperiodic_percentage}), upper_strict=${var.fileservices_requests_error_aperiodic_upper_strict}).publish('WARN')
	EOF
...
resource "signalfx_detector" "queueservices_requests_error" {
	...
	program_text = <<-EOF
		...
		aperiodic.range_detector(signal, ${var.queueservices_requests_error_threshold_warning}, ${var.queueservices_requests_error_threshold_critical}, 'within_range', lasting('${var.queueservices_requests_error_aperiodic_duration}', ${var.queueservices_requests_error_aperiodic_percentage}), upper_strict=${var.queueservices_requests_error_aperiodic_upper_strict}).publish('WARN')
	EOF
...
resource "signalfx_detector" "blobservices_latency" {
	...
	program_text = <<-EOF
		...
		aperiodic.range_detector(signal, ${var.blobservices_latency_threshold_warning}, ${var.blobservices_latency_threshold_critical}, 'within_range', lasting('${var.blobservices_latency_aperiodic_duration}', ${var.blobservices_latency_aperiodic_percentage}), upper_strict=${var.blobservices_latency_aperiodic_upper_strict}).publish('WARN')
	EOF
...
resource "signalfx_detector" "fileservices_latency" {
	...
	program_text = <<-EOF
		...
		aperiodic.range_detector(signal, ${var.fileservices_latency_threshold_warning}, ${var.fileservices_latency_threshold_critical}, 'within_range', lasting('${var.fileservices_latency_aperiodic_duration}', ${var.fileservices_latency_aperiodic_percentage}), upper_strict=${var.fileservices_latency_aperiodic_upper_strict}).publish('WARN')
	EOF
...
resource "signalfx_detector" "queueservices_latency" {
	...
	program_text = <<-EOF
		...
		aperiodic.range_detector(signal, ${var.queueservices_latency_threshold_warning}, ${var.queueservices_latency_threshold_critical}, 'within_range', lasting('${var.queueservices_latency_aperiodic_duration}', ${var.queueservices_latency_aperiodic_percentage}), upper_strict=${var.queueservices_latency_aperiodic_upper_strict}).publish('WARN')
	EOF
...
resource "signalfx_detector" "tableservices_latency" {
	...
	program_text = <<-EOF
		...
		aperiodic.range_detector(signal, ${var.tableservices_latency_threshold_warning}, ${var.tableservices_latency_threshold_critical}, 'within_range', lasting('${var.tableservices_latency_aperiodic_duration}', ${var.tableservices_latency_aperiodic_percentage}), upper_strict=${var.tableservices_latency_aperiodic_upper_strict}).publish('WARN')
	EOF
...
resource "signalfx_detector" "blob_timeout_error_requests" {
	...
	program_text = <<-EOF
		...
		aperiodic.range_detector(signal, ${var.blob_timeout_error_requests_threshold_warning}, ${var.blob_timeout_error_requests_threshold_critical}, 'within_range', lasting('${var.blob_timeout_error_requests_aperiodic_duration}', ${var.blob_timeout_error_requests_aperiodic_percentage}), upper_strict=${var.blob_timeout_error_requests_aperiodic_upper_strict}).publish('WARN')
	EOF
...
resource "signalfx_detector" "file_timeout_error_requests" {
	...
	program_text = <<-EOF
		...
		aperiodic.range_detector(signal, ${var.file_timeout_error_requests_threshold_warning}, ${var.file_timeout_error_requests_threshold_critical}, 'within_range', lasting('${var.file_timeout_error_requests_aperiodic_duration}', ${var.file_timeout_error_requests_aperiodic_percentage}), upper_strict=${var.file_timeout_error_requests_aperiodic_upper_strict}).publish('WARN')
	EOF
...
resource "signalfx_detector" "blob_network_error_requests" {
	...
	program_text = <<-EOF
		...
		aperiodic.range_detector(signal, ${var.blob_network_error_requests_threshold_warning}, ${var.blob_network_error_requests_threshold_critical}, 'within_range', lasting('${var.blob_network_error_requests_aperiodic_duration}', ${var.blob_network_error_requests_aperiodic_percentage}), upper_strict=${var.blob_network_error_requests_aperiodic_upper_strict}).publish('WARN')
	EOF
...
resource "signalfx_detector" "file_network_error_requests" {
	...
	program_text = <<-EOF
		...
		aperiodic.range_detector(signal, ${var.file_network_error_requests_threshold_warning}, ${var.file_network_error_requests_threshold_critical}, 'within_range', lasting('${var.file_network_error_requests_aperiodic_duration}', ${var.file_network_error_requests_aperiodic_percentage}), upper_strict=${var.file_network_error_requests_aperiodic_upper_strict}).publish('WARN')
	EOF
...
resource "signalfx_detector" "queue_network_error_requests" {
	...
	program_text = <<-EOF
		...
		aperiodic.range_detector(signal, ${var.queue_network_error_requests_threshold_warning}, ${var.queue_network_error_requests_threshold_critical}, 'within_range', lasting('${var.queue_network_error_requests_aperiodic_duration}', ${var.queue_network_error_requests_aperiodic_percentage}), upper_strict=${var.queue_network_error_requests_aperiodic_upper_strict}).publish('WARN')
	EOF
...
resource "signalfx_detector" "table_network_error_requests" {
	...
	program_text = <<-EOF
		...
		aperiodic.range_detector(signal, ${var.table_network_error_requests_threshold_warning}, ${var.table_network_error_requests_threshold_critical}, 'within_range', lasting('${var.table_network_error_requests_aperiodic_duration}', ${var.table_network_error_requests_aperiodic_percentage}), upper_strict=${var.table_network_error_requests_aperiodic_upper_strict}).publish('WARN')
	EOF
...
resource "signalfx_detector" "table_throttling_error_requests" {
	...
	program_text = <<-EOF
		...
		aperiodic.range_detector(signal, ${var.table_throttling_error_requests_threshold_warning}, ${var.table_throttling_error_requests_threshold_critical}, 'within_range', lasting('${var.table_throttling_error_requests_aperiodic_duration}', ${var.table_throttling_error_requests_aperiodic_percentage}), upper_strict=${var.table_throttling_error_requests_aperiodic_upper_strict}).publish('WARN')
	EOF
...
resource "signalfx_detector" "file_server_other_error_requests" {
	...
	program_text = <<-EOF
		...
		aperiodic.range_detector(signal, ${var.file_server_other_error_requests_threshold_warning}, ${var.file_server_other_error_requests_threshold_critical}, 'within_range', lasting('${var.file_server_other_error_requests_aperiodic_duration}', ${var.file_server_other_error_requests_aperiodic_percentage}), upper_strict=${var.file_server_other_error_requests_aperiodic_upper_strict}).publish('WARN')
	EOF
