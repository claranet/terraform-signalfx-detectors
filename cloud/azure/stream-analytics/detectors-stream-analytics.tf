resource "signalfx_detector" "heartbeat" {
  name = format("%s %s", local.name_prefix, "Azure Stream Analytics heartbeat")
...
resource "signalfx_detector" "su_utilization" {
  name = format("%s %s", local.name_prefix, "Azure Stream Analytics resource utilization")
...
resource "signalfx_detector" "failed_function_requests" {
  name = format("%s %s", local.name_prefix, "Azure Stream Analytics failed function requests rate")
...
resource "signalfx_detector" "conversion_errors" {
  name = format("%s %s", local.name_prefix, "Azure Stream Analytics conversion errors rate")
...
resource "signalfx_detector" "runtime_errors" {
  name = format("%s %s", local.name_prefix, "Azure Stream Analytics runtime errors rate")
