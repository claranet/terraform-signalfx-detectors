# APP-SERVICE-PLAN SignalFx detectors
...
```hcl
module "signalfx-detectors-cloud-azure-app-service-plan" {
  source = "github.com/claranet/terraform-signalfx-detectors.git//cloud/azure/app-service-plan?ref={revision}"
