...
```hcl
module "signalfx-detectors-cloud-azure-cosmos-db" {
  source = "github.com/claranet/terraform-signalfx-detectors.git//cloud/azure/cosmos-db?ref={revision}"
