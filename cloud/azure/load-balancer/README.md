# LOAD-BALANCER SignalFx detectors
...
```hcl
module "signalfx-detectors-cloud-azure-load-balancer" {
  source = "github.com/claranet/terraform-signalfx-detectors.git//cloud/azure/load-balancer?ref={revision}"
