# SQL-DATABASE SignalFx detectors
...
```hcl
module "signalfx-detectors-cloud-azure-sql-database" {
  source = "github.com/claranet/terraform-signalfx-detectors.git//cloud/azure/sql-database?ref={revision}"
