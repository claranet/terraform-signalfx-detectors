...
resource "signalfx_detector" "http_4xx_errors" {
	...
	program_text = <<-EOF
		...
		aperiodic.range_detector(signal, ${var.http_4xx_errors_threshold_warning}, ${var.http_4xx_errors_threshold_critical}, 'within_range', lasting('${var.http_4xx_errors_aperiodic_duration}', ${var.http_4xx_errors_aperiodic_percentage}), upper_strict=False).publish('WARN')
	EOF
...
resource "signalfx_detector" "http_5xx_errors" {
	...
	program_text = <<-EOF
		...
		aperiodic.range_detector(signal, ${var.http_5xx_errors_threshold_warning}, ${var.http_5xx_errors_threshold_critical}, 'within_range', lasting('${var.http_5xx_errors_aperiodic_duration}', ${var.http_5xx_errors_aperiodic_percentage}), upper_strict=False).publish('WARN')
	EOF
...
resource "signalfx_detector" "backend_http_4xx_errors" {
	...
	program_text = <<-EOF
		...
		aperiodic.range_detector(signal, ${var.backend_http_4xx_errors_threshold_warning}, ${var.backend_http_4xx_errors_threshold_critical}, 'within_range', lasting('${var.backend_http_4xx_errors_aperiodic_duration}', ${var.backend_http_4xx_errors_aperiodic_percentage}), upper_strict=False).publish('WARN')
	EOF
...
resource "signalfx_detector" "backend_http_5xx_errors" {
	...
	program_text = <<-EOF
		...
		aperiodic.range_detector(signal, ${var.backend_http_5xx_errors_threshold_warning}, ${var.backend_http_5xx_errors_threshold_critical}, 'within_range', lasting('${var.backend_http_5xx_errors_aperiodic_duration}', ${var.backend_http_5xx_errors_aperiodic_percentage}), upper_strict=False).publish('WARN')
	EOF
