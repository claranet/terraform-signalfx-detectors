# SQL-ELASTIC-POOL SignalFx detectors
...
```hcl
module "signalfx-detectors-cloud-azure-sql-elastic-pool" {
  source = "github.com/claranet/terraform-signalfx-detectors.git//cloud/azure/sql-elastic-pool?ref={revision}"
