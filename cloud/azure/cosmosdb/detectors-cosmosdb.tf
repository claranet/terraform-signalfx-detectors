...
resource "signalfx_detector" "db_4xx_requests" {
	...
	program_text = <<-EOF
		...
		aperiodic.range_detector_with_clear(signal, ${var.db_4xx_requests_threshold_warning}, ${var.db_4xx_requests_threshold_critical}, 'within_range', lasting('${var.db_4xx_requests_aperiodic_duration}', ${var.db_4xx_requests_aperiodic_percentage}), upper_strict=${var.db_4xx_requests_aperiodic_upper_strict}).publish('WARN')
	EOF
...
resource "signalfx_detector" "db_5xx_requests" {
	...
	program_text = <<-EOF
		...
		aperiodic.range_detector_with_clear(signal, ${var.db_5xx_requests_threshold_warning}, ${var.db_5xx_requests_threshold_critical}, 'within_range', lasting('${var.db_5xx_requests_aperiodic_duration}', ${var.db_5xx_requests_aperiodic_percentage}), upper_strict=${var.db_5xx_requests_aperiodic_upper_strict}).publish('WARN')
	EOF
...
resource "signalfx_detector" "scaling" {
	...
	program_text = <<-EOF
		...
		aperiodic.range_detector_with_clear(signal, ${var.scaling_threshold_warning}, ${var.scaling_threshold_critical}, 'within_range', lasting('${var.scaling_aperiodic_duration}', ${var.scaling_aperiodic_percentage}), upper_strict=${var.scaling_aperiodic_upper_strict}).publish('WARN')
	EOF
