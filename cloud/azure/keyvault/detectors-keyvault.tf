resource "signalfx_detector" "heartbeat" {
  ...
  program_text = <<-EOF
		...
		signal = data('ServiceApiHit', filter=filter('resource_type', 'Microsoft.KeyVault/vaults') and filter('primary_aggregation_type', 'true') and ${module.filter-tags.filter_custom}).publish('signal')
