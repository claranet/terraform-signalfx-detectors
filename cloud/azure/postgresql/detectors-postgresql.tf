resource "signalfx_detector" "heartbeat" {
  ...
  program_text = <<-EOF
        ...
        signal = data('network_bytes_ingress', filter=filter('resource_type', 'Microsoft.DBforPostgreSQL/servers') and filter('primary_aggregation_type', 'true') and ${module.filter-tags.filter_custom}).publish('signal')
