resource "signalfx_detector" "sending_operations" {
  name = format("%s %s", local.name_prefix, "GCP Pub/Sub Topic sending messages operations")
...
resource "signalfx_detector" "unavailable_sending_operations" {
  name = format("%s %s", local.name_prefix, "GCP Pub/Sub Topic sending unavailable messages")
...
resource "signalfx_detector" "unavailable_sending_operations_ratio" {
  name = format("%s %s", local.name_prefix, "GCP Pub/Sub Topic sending unavailable messages ratio")
