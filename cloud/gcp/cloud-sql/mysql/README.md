...
```hcl
module "signalfx-detectors-cloud-gcp-cloud-sql-mysql" {
  source = "github.com/claranet/terraform-signalfx-detectors.git//cloud/gcp/cloud-sql/mysql?ref={revision}"
...
* GCP Cloud SQL MySQL replication lag
