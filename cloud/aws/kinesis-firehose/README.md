# KINESIS-FIREHOSE SignalFx detectors
...
```hcl
module "signalfx-detectors-cloud-aws-kinesis-firehose" {
  source = "github.com/claranet/terraform-signalfx-detectors.git//cloud/aws/kinesis-firehose?ref={revision}"
