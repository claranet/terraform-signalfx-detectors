...
```hcl
module "signalfx-detectors-cloud-aws-rds-aurora-postgresql" {
  source = "github.com/claranet/terraform-signalfx-detectors.git//cloud/aws/rds/aurora/postgresql?ref={revision}"
