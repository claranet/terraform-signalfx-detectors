resource "signalfx_detector" "heartbeat" {
  name = format("%s %s", local.name_prefix, "AWS ELB heartbeat")
...
resource "signalfx_detector" "no_healthy_instances" {
  name = format("%s %s", local.name_prefix, "AWS ELB healthy instances percentage")
...
resource "signalfx_detector" "elb_4xx" {
  name = format("%s %s", local.name_prefix, "AWS ELB 4xx error rate")
...
resource "signalfx_detector" "elb_5xx" {
  name = format("%s %s", local.name_prefix, "AWS ELB 5xx error rate")
...
resource "signalfx_detector" "backend_4xx" {
  name = format("%s %s", local.name_prefix, "AWS ELB backend 4xx error rate")
...
resource "signalfx_detector" "backend_5xx" {
  name = format("%s %s", local.name_prefix, "AWS ELB backend 5xx error rate")
...
resource "signalfx_detector" "backend_latency" {
  name = format("%s %s", local.name_prefix, "AWS ELB backend latency")
