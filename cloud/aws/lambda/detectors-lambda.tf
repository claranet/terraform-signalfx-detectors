resource "signalfx_detector" "pct_errors" {
	...
	program_text = <<-EOF
		...
		aperiodic.range_detector(signal, ${var.pct_errors_threshold_warning}, ${var.pct_errors_threshold_critical}, 'within_range', lasting('${var.pct_errors_aperiodic_duration}', ${var.pct_errors_aperiodic_percentage})).publish('WARN')
	EOF
...
resource "signalfx_detector" "errors" {
	...
	program_text = <<-EOF
		...
		aperiodic.range_detector(signal, ${var.errors_threshold_warning}, ${var.errors_threshold_critical}, 'within_range', lasting('${var.errors_aperiodic_duration}', ${var.errors_aperiodic_percentage})).publish('WARN')
	EOF
...
resource "signalfx_detector" "throttles" {
	...
	program_text = <<-EOF
		...
		aperiodic.range_detector(signal, ${var.throttles_threshold_warning}, ${var.throttles_threshold_critical}, 'within_range', lasting('${var.throttles_aperiodic_duration}', ${var.throttles_aperiodic_percentage})).publish('WARN')
	EOF
...
resource "signalfx_detector" "invocations" {
	...
	program_text = <<-EOF
		...
		aperiodic.range_detector(signal, ${var.invocations_threshold_warning}, ${var.invocations_threshold_critical}, 'within_range', lasting('${var.invocations_aperiodic_duration}', ${var.invocations_aperiodic_percentage})).publish('WARN')
	EOF
