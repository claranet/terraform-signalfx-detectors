...
```hcl
module "signalfx-detectors-cloud-aws-elasticache-memcached" {
  source = "github.com/claranet/terraform-signalfx-detectors.git//cloud/aws/elasticache/memcached?ref={revision}"
