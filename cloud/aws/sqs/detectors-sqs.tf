resource "signalfx_detector" "heartbeat" {
  name = format("%s %s", local.name_prefix, "AWS SQS heartbeat")
...
resource "signalfx_detector" "visible_messages" {
  name = format("%s %s", local.name_prefix, "AWS SQS Visible messages")
...
resource "signalfx_detector" "age_of_oldest_message" {
  name = format("%s %s", local.name_prefix, "AWS SQS Age of the oldest message")
